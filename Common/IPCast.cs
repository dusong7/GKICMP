...
namespace GK.GKICMP.Common
{
    public static class IPCast
    {
        ...
        [DllImport("IPCast_I.dll", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi, EntryPoint = "IPCAST_TxtBroadCast")]
        public static extern bool IPCAST_TxtBroadCast(IPCastTalkMonitorCallBack pFunc, object pUserContext);
