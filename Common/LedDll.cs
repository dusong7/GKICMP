...
//*****************************************************************************
        ...
        #region 创建节目对象，返回类型为 HPROGRAM（添加一个节目）、（设置节目定时）
        /********************************************************************************************
        ...
        #region 添加一个图文区域（添加一个文件到图文区）、（添加一个单行文本到图文区）、（添加一个多行文本到图文区）、（添加一个静止文本到图文区）、（快速添加一个单行文本区域）
        /*********************************************************************************************
        ...
        #region 添加一个数字时钟区域（添加一个计时区域）、（添加一个模拟时钟区域）
        /*********************************************************************************************
        ...
        #region 销毁节目对象(注意：如果此节目对象不再使用，请调用此函数销毁，否则会造成内存泄露)
        /*********************************************************************************************
