<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SysDataEdit.aspx.cs" Inherits="GKICMP.sysmanage.SysDataEdit" %>
        ...
        <div class="listcent pad0">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="listinfo">
                <tbody>
                    ...
                    <tr>
                        <td align="right" width="150">数据类型：</td>
                        <td align="left">
                            ...
                            <div class="sel" style="float: left">
                                <asp:DropDownList ID="ddl_Type" runat="server" datatype="ddl" errormsg="请选择数据类型"></asp:DropDownList>
                                <span style="color: Red">*</span>
                            </div>
                        </td>
                    </tr>
