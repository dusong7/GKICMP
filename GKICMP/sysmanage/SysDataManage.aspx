<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SysDataManage.aspx.cs" Inherits="GKICMP.sysmanage.SysDataManage" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('#btn_Add').click(function () {
                ...
                return openbox('A_id', 'SysDataEdit.aspx', '&flag=' + document.getElementById("hf_CID").value, 640, 360, -1);
            });
        });
        function editinfo(e) {
            var id = $(e).next().val();
            var flag = document.getElementById("hf_CID").value;
            return openbox('A_id', 'SysDataEdit.aspx', 'id=' + id + '&flag=' + flag, 640, 360, 0);
        }
                ...
                <tbody>
                    <tr>
                        <td align="right" width="60">
                            数据类型：</td>
                        <td width="299">
                            <asp:DropDownList ID="ddl_ddl_Type" runat="server"></asp:DropDownList>
                        </td>
                        <td>
