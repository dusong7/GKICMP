<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModuleManage.aspx.cs" Inherits="GKICMP.sysmanage.ModuleManage" %>
        ...
        <div class="positionc">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td class="positiona"><a>首页</a><span>></span><asp:Label ID="lbl_ParentMenu" runat="server" Text=""></asp:Label><span>></span><asp:Label ID="lbl_Menuname" runat="server" Text="模块管理"></asp:Label>
                    </td>
                </tr>
            </table>
        </div>
            ...
            <tr style="background: url(../images/tabimg/tabpic3.gif) bottom; vertical-align: middle; height: 30px">
                <td width="15%" class="tabfirst">
                    <div style="width: 100%; background: #1DA02B; height: 40px; margin-top: 10px; border-radius: 5px; color: #fff; line-height: 40px; text-align: left; text-indent: 20px; font-size: 14px; font-weight: bold">
                        模块列表
                                <asp:LinkButton ID="btn_Add" runat="server" OnClick="lbtn_Add_Click"><span style="position:relative; top:12px; right:5px;  float:right;color:white;font-size:12px;font-weight:100;" >添加</span>
                                </asp:LinkButton>
                    </div>
                </td>
                <td valign="top" rowspan="2">
                    <iframe scrolling="auto" width="100%" frameborder="0" src="ModulueEdit.aspx" name="framemain"
                        id="framemain" runat="server" Height="660px"></iframe>
                </td>
            </tr>
            <tr>
                <td valign="top" style="height: 90%; background: #FFFFFF">
                    <div>
                        <asp:TreeView ID="tv_Meun" ShowLines="True" Height="660px"
