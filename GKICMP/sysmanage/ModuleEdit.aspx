<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModuleEdit.aspx.cs" Inherits="GKICMP.sysmanage.ModuleEdit" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function succ() {
            window.parent.location.href = "ModuleManage.aspx";
        }
    </script>
        ...
        <div class="listcent pad0">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="listinfo">
                <tbody>
                    ...
                    <tr>
                        <td align="right" width="200px">上级模块名称：</td>
                        <td align="left">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:CheckBoxList ID="cbl_Button" CssClass="edilab" runat="server" RepeatDirection="Horizontal" RepeatColumns="14" RepeatLayout="Flow"></asp:CheckBoxList>
                        </td>
                    </tr>
                    <tr>
            ...
            <table width="100%" border="0">
                <tr>
                    <td align="center">
                        ...
                        &nbsp; &nbsp;&nbsp;&nbsp; 
                            <asp:Button ID="btn_Delete" runat="server" Text="删除" CssClass="deletebtn" OnClick="btn_Delete_Click" OnClientClick ="return confirm('确认删除选中的信息')" />
                        &nbsp; &nbsp;&nbsp;&nbsp; 
