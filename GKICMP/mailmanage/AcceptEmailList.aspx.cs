...
{
    public partial class AcceptEmailList : PageBase
    {
        ...
        private void DataBindList()
        {
            ...
            DataTable dt = emailDAL.GetPaged(Pager.PageSize, Pager.CurrentPageIndex, ref recordCount, model, begindate, enddate,2);//2收件箱
        ...
        protected void btn_Delete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int result = emailDAL.Delete(ids, (int)CommonEnum.Deleted.删除);
                if (result > 0)
                {
                    ShowMessage("删除成功");
        ...
        protected void lbtn_Detail_Click(object sender, EventArgs e)
        {
            ...
            string aa = string.Format("<script language=javascript>window.open('EmailDetail.aspx?id={0}&flag=2', '_self')</script>", id);
            Response.Write(aa);
        } 
        #endregion
    }
