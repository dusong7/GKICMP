...
{
    public partial class SendEmailManage : PageBase
    {
        ...
        private void DataBindList()
        {
            ...
            DataTable dt = emailDAL.GetPaged(Pager.PageSize, Pager.CurrentPageIndex, ref recordCount, model, begindate, enddate, 1);//1：发件箱
        ...
        protected void btn_Delete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int result = emailDAL.DeleteBat(ids, (int)CommonEnum.Deleted.删除);
                if (result > 0)
                {
                    ShowMessage("删除成功");
