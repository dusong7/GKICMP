<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DustbinManage.aspx.cs" Inherits="GKICMP.mailmanage.DustbinManage" %>
        ...
        <div class="positionc">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td class="positiona"><a>首页</a><span>></span><asp:Label ID="lbl_ParentMenu" runat="server" Text=""></asp:Label><span>></span><asp:Label ID="lbl_Menuname" runat="server" Text="垃圾箱"></asp:Label>
                    </td>
                </tr>
            </table>
        </div>
                ...
                <tbody>
                    <tr>
                        <td align="right" valign="middle">
                            <asp:Button ID="btn_ComDelete" runat="server" Text="彻底删除"  CssClass="listbtncss listdel" OnClick="btn_Delete_Click" />
                        </td>
                    </tr>
                </tbody>
            </table>
