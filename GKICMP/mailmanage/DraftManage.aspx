<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DraftManage.aspx.cs" Inherits="GKICMP.mailmanage.DraftManage" %>
        ...
        <div class="positionc">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td class="positiona"><a>首页</a><span>></span><asp:Label ID="lbl_ParentMenu" runat="server" Text=""></asp:Label><span>></span><asp:Label ID="lbl_Menuname" runat="server" Text="草稿箱"></asp:Label>
                    </td>
                </tr>
            </table>
        </div>
                ...
                <tbody>
                    <tr>
                        <td align="right" valign="middle">
                            <asp:Button ID="btn_Submit" runat="server" Text="提交"  CssClass="listbtncss listadd" OnClick="btn_Submit_Click" />
                            <asp:Button ID="btn_DeleteDraft" runat="server" Text="删除草稿"  CssClass="listbtncss listdel" OnClick="btn_Delete_Click" />
                        </td>
                    </tr>
                </tbody>
            </table>
                    ...
                    <asp:Repeater runat="server" ID="rp_List">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <asp:LinkButton ID="lbtn_Edit" runat="server" Visible='<%#Eval("IsSubmit").ToString()=="0"?true:false %>' CssClass="listbtn btneditcolor" OnClick="lbtn_Edit_Click" CommandArgument='<%#Eval("EID") %>'>编辑</asp:LinkButton>
                                        <asp:LinkButton ID="lbtn_Detail" runat="server" CssClass="listbtn btndetialcolor" CommandArgument='<%#Eval("EID") %>' OnClick="lbtn_Detail_Click">详情</asp:LinkButton>
