...
{
    public partial class DustbinManage : PageBase
    {
        ...
        private void DataBindList()
        {
            ...
            model.Isdel = (int)CommonEnum.Deleted.删除;//垃圾箱显示删除信息
            ...
            DataTable dt = emailDAL.GetPaged(Pager.PageSize, Pager.CurrentPageIndex, ref recordCount, model, begindate, enddate, 1);//
        ...
        protected void btn_Delete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int result = emailDAL.DeleteBat(ids, 2);//2彻底删除
                if (result > 0)
                {
                    ShowMessage("删除成功");
