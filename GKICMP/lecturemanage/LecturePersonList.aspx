<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LecturePersonList.aspx.cs" Inherits="GKICMP.lecturemanage.LecturePersonList" %>
        ...
        <div class="positionc">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td class="positiona"><a>首页</a><span>></span><asp:Label ID="lbl_ParentMenu" runat="server" Text=""></asp:Label><span>></span><asp:Label ID="lbl_Menuname" runat="server" Text="我的听课"></asp:Label>
                    </td>
                </tr>
            </table>
        </div>
