<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeacherActivityManage.aspx.cs" Inherits="GKICMP.lecturemanage.TeacherActivityManage" %>
    ...
    <script type="text/javascript">
        $(function () {
            $('#btn_Add').click(function () {
                ...
                return openbox('A_id', 'TeacherActivityEdit.aspx', '', 940, 550, -1);
            });
        });

        function editinfo(e) {
            var id = $(e).next().next().val();
            return openbox('A_id', 'TeacherActivityEdit.aspx', 'id=' + id, 940, 550, 0);
        }

        function viewinfo(e) {
            var id = $(e).next().val();
            return openbox('A_id', 'TeacherActivityDetail.aspx', 'id=' + id, 860, 480, 4);
        }
    </script>
</head>
<body>
