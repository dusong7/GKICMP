<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LectureDetail.aspx.cs" Inherits="GKICMP.lecturemanage.LectureDetail" %>
        ...
        <div style="line-height: 26px; width: 98%; margin: auto; margin-top: 15px; font-size: 12px; font-family: 微软雅黑体; background: #f5f5f5;">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td class="positiona"><a>首页</a><span>></span>公开课管理<span>></span><asp:Label ID="lbl_Menuname" runat="server" Text="我的听课"></asp:Label>
                    </td>
                </tr>
            </table>
        </div>
