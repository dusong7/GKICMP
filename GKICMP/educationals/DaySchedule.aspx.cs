...
{
    public partial class DaySchedule : PageBase
    {
        ...
        public void DdlBind()
        {
            ...
            if (model != null)
            {
                ...
                {
                    this.ddl_Day.Items.Add(new ListItem(i == 1 ? "周一" : i == 2 ? "周二" : i == 3 ? "周三" : i == 4 ? "周四" : i == 5 ? "周五" : i == 6 ? "周六" : "周日", i.ToString()));
                }
            }
        }
        #endregion
        ...
        public string DataBindList()
        {
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                ...
                for (int j = 0; j <= (WSnum + SWnum + XWnum); j++)
                {
                    if (j == 0)
                    {
                    ...
                    {
                        str.AppendFormat("<td  class='contd1'>{0}</td>", "第" + j.ToString() + "节课");
                    }
                }
                ...
                for (int k = 0; k < dt.Rows.Count; k++)
                {
                    ...
                    string sql1 = " and ClaID=" + ClaID + " and Isdel=0 and Position like '" + Convert.ToInt32(this.ddl_Day.SelectedValue) + "%' and EYear='" + EYear + "' and Term=" + term + " and ClaID not in (select DID from Tb_Department a,Tb_Grade b where a.GID=b.GID and a.DepType=-1 and b.IsGraduate=1) order by Position";
                    ...
                    {
                        string aa = "";
                        strGet(this.ddl_Day.SelectedValue + "0" + a, dt1, out aa);
                        if (aa == "无课")
                        {
