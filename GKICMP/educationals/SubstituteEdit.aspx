<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubstituteEdit.aspx.cs" Inherits="GKICMP.educationals.SubstituteEdit" %>
                ...
                <tr>
                    <td colspan="4" align="center">
                        <span style="font-size: x-large; float: left; margin-right: 5px;">
                            注：1.<span style="color:red;">课程+ 姓名</span>表示安排中，代课人还没同意，可再次安排代课<br/>
                ...
                success: function (data) {
                    ...
                    if (data.result == 'true') {
                        for (var i = 0; i < data.data.length; i++) {
                            //str += "<li type=\"button\" onclick='add(\"" + data.data[i].TID + "\",\"" + abid + "\")'>" + data.data[i].TeacherName + "</li>";
                              str += "<li type=\"button\" onclick='add(\"" + data.data[i].TID + "\",\"" + abid + "\")'>" + "<i>" + data.data[i].TeacherName + "</i>" + "<span>" + '[' + data.data[i].nj + ']' + "</span>" + "</li>";
    ...
    function add(tid, abid) {
        if (tid != "" && abid != "") {
            ...
            $.ajax({
                ...
                type: "get",
                async: false,
                data: "method=TeacherUpdate&tid=" + tid + "&abid=" + abid,
                dataType: "json",
                success: function (data) {
                    //alert(JSON.stringify(data));
                    if (data.result == 'true') {
