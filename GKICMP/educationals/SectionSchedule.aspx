<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SectionSchedule.aspx.cs" Inherits="GKICMP.educationals.SectionSchedule" %>
                        ...
                        <th align="left">
                            <div class="xxsm">
                                <ul>
                                    ...
                                    <li><a href="DaySchedule.aspx">日课表</a></li>
                                    <li class="selected"><a href="SectionSchedule.aspx">节次课表</a></li>
                                </ul>
                            </div>
                        </th>
                    </tr>
        ...
        <div class="listcent searclass">
            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="10">
                <tbody>
                    <tr>
                        <td width="400">
                            <asp:DropDownList ID="ddl_JC" runat="server"></asp:DropDownList>
                        </td>
                        <td>
