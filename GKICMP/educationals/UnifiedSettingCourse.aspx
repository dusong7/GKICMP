<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnifiedSettingCourse.aspx.cs" Inherits="GKICMP.educationals.UnifiedSettingCourse" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="listcent pad0">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="listinfo">
                <tbody>
                    <tr>
                        <th colspan="6" align="left">统一设置课程信息</th>
                    </tr>
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="txt_Jieshu" runat="server" datatype="zhengnum" Width="45px" nullmsg="请填写每周节数"></asp:TextBox>
                            <span style="color: Red; float: none">*</span></td>
                        <td align="right">是否同步到全校课程：</td>
                        <td align="left">
                            <asp:CheckBox ID="cbx_IsTB" runat="server" />
                              </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="6" align="center">
                            <asp:Button ID="btn_Sumbit" runat="server" Text="提交" CssClass="submit" OnClick="btn_Sumbit_Click" OnClientClick='return confirm("统一添加课程将同步到其他班级，确定添加？")' />
