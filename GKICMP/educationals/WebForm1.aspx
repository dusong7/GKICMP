<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="GKICMP.educationals.WebForm1" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="listcent pad0" style="position: relative;">
            <div style="overflow-x: auto; text-align: center; padding-bottom: 30px" id="goodsList">
                <asp:Label ID="lbl" runat="server"></asp:Label>
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="listbt" style="position: absolute; bottom: 0px">
                    <tbody>
                        <tr>
                            <td>
                                <asp:Button ID="btn_OutPut" runat="server" Text="导出" CssClass="listoutput" OnClick="btn_OutPut_Click" />
                            </td>
                        </tr>
                    </tbody>
                </table>
