<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeacherManage.aspx.cs" Inherits="GKICMP.teachermanage.TeacherManage" %>
        ...
        <div class="positionc">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td class="positiona"><a>首页</a><span>></span><asp:Label ID="lbl_ParentMenu" runat="server" Text="教师管理"></asp:Label><span>></span><asp:Label ID="lbl_Menuname" runat="server" Text="教师信息管理"></asp:Label>
                    </td>
                </tr>
            </table>
        </div>
            ...
            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="10">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td colspan="9">                           
                                <asp:TextBox ID="txt_TeaState" runat="server" multiline="true" multiple="true" name="ClassRoom" onlyLeafCheck="true" url="../ashx/data.ashx" CssClass="easyui-combotree" Width="100%"></asp:TextBox>
                        </td>
                    </tr>
                </tbody>
            </table>
