<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EducationImport.aspx.cs" Inherits="GKICMP.teachermanage.EducationImport" %>
        ...
        <div class="listcent pad0">
            <div>
                <table width="100%" cellspacing="0" cellpadding="0" class="listinfo1">
                    <tr>
                        <th colspan="4" align="left">学历导入
                        </th>
                    </tr>
                    <tr>
                        <td align="right">学历信息：</td>
                        <td>
