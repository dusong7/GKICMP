<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeacherGuidanceManage.aspx.cs" Inherits="GKICMP.teachermanage.TeacherGuidanceManage" %>
    ...
    <script type="text/javascript">
        $(function () {
            $('#btn_Add').click(function () {
                return openbox('A_id', 'TeacherGuidanceEdit.aspx', '', 900, 500, -1);
            });
        });
        function editinfo(e) {
            var id = $(e).next().val();
            return openbox('A_id', 'TeacherGuidanceEdit.aspx', 'id=' + id, 900, 500, 0);
        }
        function viewinfo(e) {
            var id = $(e).next().val();
            return openbox('A_id', 'TeacherGuidanceDetail.aspx', 'id=' + id, 860, 470, 4);
        }
    </script>
</head>
<body>
    <form id="form1" runat="server">
        ...
        <div class="positionc">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td class="positiona"><a>首页</a><span>></span><asp:Label ID="lbl_ParentMenu" runat="server" Text=""></asp:Label><span>></span><asp:Label ID="lbl_Menuname" runat="server" Text="指导学生获奖"></asp:Label>
                    </td>
                </tr>
            </table>
        </div>
        ...
        <%--<div class="dvTab">
            <ul class="menuall">
                ...
                <li class="tab activeTab"><a href="TeacherGuidanceManage.aspx">指导学生获奖</a></li>
            </ul>
            <div class="dv"></div>
        </div>--%>
            ...
            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="10">
                <tbody>
                    <tr>
                        ...
                        <td width="150">
                            <asp:TextBox ID="txt_RewardName" runat="server"></asp:TextBox>
                        </td>
                ...
                <tbody>
                    ...
                    <asp:Repeater ID="rp_List" runat="server">
                        <ItemTemplate>
                            <tr>
                                <td style="width: 5px">
                                    <label class="wxz" id='ck_<%#Eval("TGID")%>l'>
                                        <input type="checkbox" name="checkbox" onclick="setid(this.id)" value='<%#Eval("TGID") %>' id='ck_<%#Eval("TGID") %>' /></label>
                                </td>
                                <td align="center"><%#Eval("TeacherName")%></td>
                             <%--   <td align="center"><%#Eval("RewardName")%></td>--%>
                                ...
                                <td><%#Eval("RGrade")%></td>
                                <td><%#GK.GKICMP.Common.CommonFunction.CheckEnum<GK.GKICMP.Common.CommonEnum.URole>(Eval("GRole"))%></td>
                               ...
                               <%-- <td><%#Eval("IsReport").ToString()=="0"? "<span style='color:red'>未上报</span>":"已上报" %></td>--%>
                                ...
                                <td>
                                    ...
                                    <asp:HiddenField ID="hf_SelectID" Value='<%#Eval("TGID") %>' runat="server" />
                                    ...
                                    <asp:HiddenField ID="hf_TPID" Value='<%#Eval("TGID") %>' runat="server" />
                                    <asp:LinkButton ID="lbtn_Report" runat="server" CssClass="listbtn btnreportncolor" ToolTip="上报" CommandArgument='<%#Eval("TGID") %>' OnClick="lbtn_SB_Click" OnClientClick="return  confirm('您确认要上报该信息吗？');">上报</asp:LinkButton>
                                    <asp:HiddenField ID="hf_sTPID" Value='<%#Eval("TGID") %>' runat="server" />
                                </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
