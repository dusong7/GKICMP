<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AttendRecordReport.aspx.cs" Inherits="GKICMP.teachermanage.AttendRecordReport" %>
                ...
                <tbody>
                    <tr>
                       ...
                       <%-- <th align="center">工号</th>--%>
                        ...
                        <th align="center">早退</th>
                        <th align="center">外出次数</th>
                        ...
                        <ItemTemplate>
                            <tr>
                               ...
                               <%-- <td><%#Eval("UserNum")%></td>--%>
                                ...
                                <td><%#GK.GKICMP.Common.CommonFunction.CheckEnum<GK.GKICMP.Common.CommonEnum.IsorNot>(Eval("IsAnalysis"))%></td>
                             <%--   <td>
                                    <div >--%>
