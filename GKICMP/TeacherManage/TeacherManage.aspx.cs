...
{
    public partial class TeacherManage : PageBase
    {
        ...
        protected void btn_OutPut_Click(object sender, EventArgs e)
        {
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    list.Add(dr["PartyTme"].ToString() == "" ? "" : Convert.ToDateTime(dr["PartyTme"]).ToString("yyyy-MM-dd") == "1900-01-01" ? "" : dr["PartyTme"].ToString());
                    list.Add(dr["MaritalStatusName"].ToString());
                    list.Add(CommonFunction.CheckEnum<CommonEnum.HealthStatus>(dr["HealthStatus"].ToString()));
                    list.Add(dr["Email"].ToString() == "" ? "" : dr["Email"].ToString());
                    list.Add(dr["TeaAddress"].ToString() == "" ? "" : dr["TeaAddress"].ToString());
                    ...
                    list.Add(dr["PostRole"].ToString() == "" ? "" : dr["PostRole"].ToString());
                    ...
                    list.Add(dr["GradeDate"].ToString() == "" ? "" : Convert.ToDateTime(dr["GradeDate"]).ToString("yyyy-MM-dd") == "1900-01-01" ? "" : dr["GradeDate"].ToString());
                    list.Add(dr["SalaryGrade"].ToString() == "" ? "" : dr["SalaryGrade"].ToString());
                    ...
                    list.Add(dr["TeaQualCode"].ToString() == "" ? "" : dr["TeaQualCode"].ToString());
                    list.Add(dr["TeaQualCourseName"].ToString() == "" ? "" : dr["TeaQualCourseName"].ToString());
                    list.Add(dr["TeaQualDate"].ToString() == "" ? "" : Convert.ToDateTime(dr["TeaQualDate"]).ToString("yyyy-MM-dd") == "1900-01-01" ? "" : dr["TeaQualDate"].ToString());
                    list.Add(dr["TeaQualRegDate"].ToString() == "" ? "" : Convert.ToDateTime(dr["TeaQualRegDate"]).ToString("yyyy-MM-dd") == "1900-01-01" ? "" : dr["TeaQualRegDate"].ToString());
