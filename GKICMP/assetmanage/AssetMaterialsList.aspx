<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AssetMaterialsList.aspx.cs" Inherits="GKICMP.assetmanage.AssetMaterialsList" %>
    ...
    <script type="text/javascript">
        $(function () {
            $('#btn_Add').click(function () {
                ...
                return openbox('A_id', 'AssetsTypeEdit.aspx', '&flag=2'+'&type=1', 860, 420, -1);
            });
        });
        function showbox(id) {
            //var id = $(e).next().next().val();
            return openbox('A_id', 'AssetsTypeEdit.aspx', 'pid=' + id + '&flag=2'+'&type=1', 860, 420, -1);
        }

        function editinfo(id) {
            return openbox('A_id', 'AssetsTypeEdit.aspx', 'id=' + id + '&flag=2'+'&type=1', 860, 420, 0);
        }
