<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RepairMaintenance.aspx.cs" Inherits="GKICMP.assetmanage.RepairMaintenance" %>
                    ...
                    <th colspan="7" align="left" style="padding-left: 15px">
                        <div class="xxsm">
                            <ul>
                                ...
                                <li ><a href="RepairReportSum.aspx">按月份统计</a></li>
                                <li class="selected"><a href="RepairMaintenance.aspx">按维修员统计</a></li>
                            </ul>
                        </div>
                    </th>
                </tr>
                ...
                <tbody>
                    <tr>
                       <%-- <th style="text-align:center" >序号</th>--%>
                        <th style="text-align:center" >维修员</th>
                        <th style="text-align:center" >总数</th>
                        <th style="text-align:center" >未维修</th>
                         <%--<th style="text-align:center" >已受理</th>--%>
                        <th style="text-align:center" >已维修</th>
                        <th style="text-align:center" >待确认完成</th>
                    </tr>
                        ...
                        <ItemTemplate>
                            <tr>
                               <%-- <td><%#Container.ItemIndex + 1%></td>--%>
                                <td align="center"><%#Eval("CreaterUserName") %></td>
                                <td align="center"><%#Eval("zg") %></td>
                                <td align="center"><%#Eval("yj") %></td>
                                <%-- <td align="center"><%#Eval("sl") %></td>--%>
                                <td align="center"><%#Eval("wc") %></td>
                                <td align="center"><%#Eval("qrwc") %></td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
