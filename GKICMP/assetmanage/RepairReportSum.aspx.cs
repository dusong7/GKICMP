...
{
    public partial class RepairReportSum : PageBase
    {
        ...
        public void InfoBind()
        {
            ...
            //DataTable dt = asset_RepairDAL.GetList(Convert.ToDateTime(ViewState["begin"].ToString()), Convert.ToDateTime(ViewState["end"].ToString()));
            DataTable dtsum = asset_RepairDAL.GetListCounts(Convert.ToDateTime(ViewState["begin"].ToString()), Convert.ToDateTime(ViewState["end"].ToString()));
            ...
            if (dtsum != null && dtsum.Rows.Count > 0)
            {
                ...
                {
                    a += "['" + dr["ym"].ToString() + "'," + dr["counts"].ToString() + "],";
                }
        ...
        protected void btn_OutPut_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = asset_RepairDAL.GetListCounts(Convert.ToDateTime(ViewState["begin"].ToString()), Convert.ToDateTime(ViewState["end"].ToString()));
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                ...
                {
                    str.Append("<tr>");
                    str.AppendFormat("<td>{0}</td>", row["ym"]);
                    str.AppendFormat("<td>{0}</td>", row["counts"]);
                    str.Append("</tr>");
                }
            }
            CommonFunction.ExportExcel("报修记录月份统计", str.ToString());
