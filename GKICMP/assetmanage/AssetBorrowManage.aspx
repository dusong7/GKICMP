<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AssetBorrowManage.aspx.cs" Inherits="ICMP.assetmanage.AssetBorrowManage" %>
    ...
    <form runat="server">
        ...
        <div class="listcent searclass">
            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="10">
                <tbody>
                    <tr>
                        <td align="right" width="60"> <asp:Literal ID="ltl_tname1" runat="server" ></asp:Literal>名称：</td>
                        <td width="150">
                            <asp:TextBox ID="txt_AassetName" runat="server" width="150"></asp:TextBox>
                        </td>
                        <td align="right" width="80"><asp:Literal ID="ltl_type1" runat="server"></asp:Literal>分类：</td>
                        <td width="170">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="listinfo">
                <tbody>
                    <tr>
                        ...
                        <th align="center"><asp:Literal ID="ltl_type" runat="server"></asp:Literal>分类</th>
                        <th align="center"><asp:Literal ID="ltl_tname" runat="server"></asp:Literal>名称</th>
                        <th align="center"><asp:Literal ID="ltl_number" runat="server"></asp:Literal>编号</th>
                        <th align="center">
                     ...
                     <%--   <th align="center">状态</th>--%>
                        <th align="center" runat="server" id="th2">归还日期</th>
                        ...
                        <ItemTemplate>
                            <tr>
                              ...
                              <%--  <td><%#GK.GKICMP.Common.CommonFunction.CheckEnum<GK.GKICMP.Common.CommonEnum.ABState>(Eval("ABState"))%></td>--%>
                                <td runat="server" id="td2"><%#Eval("BackDate","{0:yyyy-MM-dd}")%></td>
                                <td>
