<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WarehouseManage.aspx.cs" Inherits="GKICMP.assetmanage.WarehouseManage" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('#btn_Add').click(function () {
                ...
                return openbox('A_id', 'WarehouseEdit.aspx', '', 640, 360, -1);
            });
        });
        function editinfo(e) {
            var id = $(e).next().val();
            var flag = document.getElementById("hf_CID").value;
            return openbox('A_id', 'WarehouseEdit.aspx', 'id=' + id + '&flag=' + flag, 640, 360, 0);
        }
        ...
        <div class="positionc">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td class="positiona"><a>首页</a><span>></span><asp:Label ID="lbl_ParentMenu" runat="server" Text=""></asp:Label><span>></span><asp:Label ID="lbl_Menuname" runat="server" Text="仓库管理"></asp:Label>
                    </td>
                </tr>
            </table>
        </div>
                ...
                <tbody>
                    <tr>
                        <td align="right" width="60">
                            仓库名称：</td>
                        <td width="299">
                            <asp:TextBox ID="txt_DataName" runat="server"></asp:TextBox>
                        </td>
                        <td>
