<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AssetDetail.aspx.cs" Inherits="ICMP.assetmanage.AssetDetail" %>
    ...
    <form id="form1" runat="server">
        <div class="listcent pad0">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="listinfo">
                <tbody>
                    <tr>
                        <td colspan="4" align="center" style="font-size: 18px; font-weight: bold;"><asp:Literal ID="lbl_Type1" runat="server"></asp:Literal>信息</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td align="left">
                         ...
                         <td align="right" width="100px">资产分组</td>
                        <td align="left">
                            <asp:Label ID="lbl_AssetGroupName" runat="server" Text=""></asp:Label>
                        </td>
                    </tr>
                     <tr>
