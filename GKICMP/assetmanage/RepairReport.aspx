<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RepairReport.aspx.cs" Inherits="GKICMP.assetmanage.RepairReport" %>
            ...
            <tbody>
                <tr>
                    <th colspan="7" align="left" style="padding-left: 15px">
                        <div class="xxsm">
                            <ul>
                                <li class="selected"><a href="RepairReport.aspx">按教师统计</a></li>
            ...
            <table width="100%" border='0' cellspacing='0' cellpadding="0" class='listinfoc'>
                <tbody>
                    <tr>
                        ...
                        <th style="text-align:center" >未处理</th>
                        <th style="text-align:center" >已受理</th>
                        <th style="text-align:center" >已完成</th>
                        <th style="text-align:center" >确认完成</th>
                    </tr>
