...
{
    public partial class AssetBorrowManage : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if (Flag == 1)
                {
                    this.btntab.Visible = true;
                    this.ltl_Name.Text = this.ltl_NameS.Text = "借用人";
                    this.ltl_Date.Text = this.ltl_DateS.Text = "借用日期";
                    this.ltl_AssetNum.Text = "借出数量";
                    this.lbl_Menuname.Text = "借出管理";
                    this.ltl_type1.Text = this.ltl_tname1.Text = this.ltl_tname.Text = this.ltl_number.Text = this.ltl_type.Text = "资产";
                ...
                else
                {
                    ...
                    this.ltl_type1.Text = this.ltl_tname1.Text = this.ltl_tname.Text = this.ltl_number.Text = this.ltl_type.Text = "";
        ...
        {
            int recordCount = -1;
            Asset_BorrowEntity model = new Asset_BorrowEntity(Convert.ToDateTime(ViewState["BeginDate"]), Convert.ToDateTime(ViewState["EndDate"]), Flag, (int)CommonEnum.Deleted.未删除);
            ...
            if (Flag == 2)
            {
                ...
                {
                    HtmlTableCell td2 = (HtmlTableCell)this.rp_List.Items[i].FindControl("td2");
                    td2.Visible = false;
                }
            }
        ...
        {
            TableCell tc = e.Item.FindControl("aa") as TableCell;
            if(tc!=null)
            {
                if (Flag == 2)
                {
