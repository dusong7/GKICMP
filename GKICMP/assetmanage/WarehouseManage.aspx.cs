...
namespace GKICMP.assetmanage
{
    public partial class WarehouseManage : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ViewState["DataName"] = CommonFunction.GetCommoneString(this.txt_DataName.Text.Trim());
        ...
        private void DataBindList()
        {
            ...
            model.DataType = (int)CommonEnum.DataType.仓库名称;
            model.DataName = ViewState["DataName"].ToString();
