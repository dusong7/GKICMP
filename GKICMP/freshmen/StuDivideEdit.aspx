<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StuDivideEdit.aspx.cs" Inherits="GKICMP.freshmen.StuDivideEdit" %>
                ...
                <tbody>
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <td align="left">
                            <asp:DropDownList runat="server" datatype="ddl" errormsg="请选择家长最高学历" ID="ddl_HighEducation"></asp:DropDownList>
                            <span style="color: Red; float: none">*</span>
                        </td>
                        <td align="right">家长交流水平：</td>
                        <td>
                           <asp:DropDownList runat="server" datatype="ddl" errormsg="请选择家长交流水平" ID="ddl_LevelCommunication"></asp:DropDownList>
                           <span style="color: Red; float: none">*</span>
                        </td>
                    </tr>
