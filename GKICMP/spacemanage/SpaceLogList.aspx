<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SpaceLogList.aspx.cs" Inherits="GKICMP.spacemanage.SpaceLogList" %>
    ...
    <script type="text/javascript">
        $(function () {
            $('#btn_Add').click(function () {
                ...
                return openbox('A_id', 'LogEdit.aspx', '', 960, 660, -1);
            });
        });
        function editinfo(e) {
        ...
        <div class="positionc">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td class="positiona"><a>首页</a><span>></span><asp:Label ID="lbl_ParentMenu" runat="server" Text=""></asp:Label><span>></span><asp:Label ID="lbl_Menuname" runat="server" Text="我的日志"></asp:Label>
                    </td>
                </tr>
            </table>
        </div>
            ...
            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="10">
                <tbody>
                    <tr>
                        ...
                        <%--<td align="right" width="60">是否私密日志：</td>
                        <td width="150">
