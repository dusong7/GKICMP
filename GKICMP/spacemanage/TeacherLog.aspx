<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TeacherLog.aspx.cs" Inherits="GKICMP.spacemanage.TeacherLog" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="menucs">
            <ul>
                ...
                <li class="selected">
                    <asp:LinkButton runat="server" ID="lbtn_ClassCul" Text="我的日志"></asp:LinkButton></li>
                <li>
        ...
        <div class="bancs gr">
            <div class="bancent">
                <div class="bantit">
                    <asp:Literal runat="server" ID="ltl_RealName"></asp:Literal>的日志
                </div>
                <%--<div class="baninfo1">
                    ...
                    <div class="listm">
                        ...
                        <div class="listb">
                            ...
                            <span>
                                ...
                                <asp:LinkButton runat="server" ID="lbtn_Edit" OnClientClick='return editinfo(this);' Visible='<%#IsVisible(Eval("SysID")) %>'>编辑</asp:LinkButton>
                                <asp:HiddenField ID="HiddenField2" Value='<%#Eval("EGID") %>' runat="server" />
                                <asp:LinkButton runat="server" ID="lbtn_Detele" OnClick="lbtn_Detele_Click" Visible='<%#IsVisible(Eval("SysID")) %>' CommandArgument='<%#Eval("EGID") %>' OnClientClick="return confirm('确认删除选中的信息吗？');">删除</asp:LinkButton>
                                <asp:LinkButton runat="server" ID="lbtn_PrivateLog" CommandArgument='<%#Eval("EGID") %>' Visible='<%#IsVisible(Eval("SysID")) %>' Text='<%#Eval("IsPublish").ToString()=="1"?"取消发布":"发布" %>' OnClick="lbtn_PrivateLog_Click"></asp:LinkButton></span>
                        </div>
                    </div>
                </ItemTemplate>
            </asp:Repeater>
