<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LogDetail.aspx.cs" Inherits="GKICMP.spacemanage.LogDetail" %>
...
<body>
    <form id="form1" runat="server">
        <div class="infocss">
            <h3>
                <asp:Literal runat="server" ID="ltl_LogTitle"></asp:Literal></h3>
            <div class="infodiv" style="text-align: center;">
                <asp:Literal runat="server" ID="ltl_LogText"></asp:Literal>
            </div>
            <div class="infoo">
            ...
            <div style="border-top: 1px dashed #808080">【日志评论】</div>
