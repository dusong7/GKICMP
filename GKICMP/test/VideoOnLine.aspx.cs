...
{
    public partial class VideoOnLine : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            this.video_content.InnerHtml = Play("http://hot.tudou.com/flv/005/680/205/5680205.flv", 472, 385);
        }
        ...
        ///   <returns></returns>    
        public string flv(string url, int width, int height)
        {
            ...
            sb.Append("<embed   src=\"\" flashvars=\"vcastr_file=" + url + "&LogoText=www.um173.com\"   height=\"" + height + "\"   width=\"" + width + "\"   quality=\"high\"   pluginspage=\"http://www.macromedia.com/go/getflashplayer\" type=\"application/x-shockwave-flash\"   menu=\"false\">");
            sb.Append("</embed>");
            sb.Append("</object>");
            return sb.ToString();
        }
        ...
        ///   <param   name="url"></param>    
        ///   <returns></returns>   
        public string wmv(string url, int width, int height)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder();
        ...
        public string wma(string url, int width, int height)
        {
            System.Text.StringBuilder sb = new System.Text.StringBuilder();
