<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyGuidanceManage.aspx.cs" Inherits="GKICMP.office.MyGuidanceManage" %>
    ...
    <script type="text/javascript">
        $(function () {
            $('#btn_Add').click(function () {
                return openbox('A_id', 'MyGuidanceEdit.aspx', '', 900, 500, -1);
            });
        });
        function editinfo(e) {
            var id = $(e).next().val();
            return openbox('A_id', 'MyGuidanceEdit.aspx', 'id=' + id, 900, 500, 0);
        }
        function viewinfo(e) {
            var id = $(e).next().val();
            return openbox('A_id', '../teachermanage/TeacherGuidanceDetail.aspx', 'id=' + id, 860, 670, 4);
        }
    </script>
</head>
<body>
        ...
        <div class="positionc">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td class="positiona"><a>首页</a><span>></span><asp:Label ID="lbl_ParentMenu" runat="server" Text=""></asp:Label><span>></span><asp:Label ID="lbl_Menuname" runat="server" Text="我的指导学生获奖"></asp:Label>
                    </td>
                </tr>
            </table>
        </div>
