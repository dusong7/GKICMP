...
{
    public partial class LeaveAuditUsers : PageBase
    {
        ...
        {
            DataTable dt = typeDAL.GetList(Flag == 1 ? (int)CommonEnum.HumanType.请假审核人 : Flag == 3 ? (int)CommonEnum.HumanType.加班审核人: (int)CommonEnum.HumanType.外出审核人);
