...
{
    public partial class MyGuidanceManage : PageBase
    {
        ...
        public void DataBindList()
        {
            ...
            DataTable dt = teacher_GuidanceDAL.GetPaged(Pager.PageSize, Pager.CurrentPageIndex, ref recordCount, model, name);
        ...
        protected void btn_Delete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (result > 0)
                {
                    sysLogDAL.Edit(new SysLogEntity((int)CommonEnum.LogType.操作日志_删除, "删除我的指导学生获奖信息", UserID));
                    ShowMessage("删除成功");
                }
                else
                {
        ...
        protected void btn_OutPut_Click(object sender, EventArgs e)
        {
            ...
            model.Isdel = (int)CommonEnum.IsorNot.否;
            string name = UserRealName;
            DataTable dt = teacher_GuidanceDAL.GetPaged(2000, 1, ref recordCount, model, name);
