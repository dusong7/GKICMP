<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TraveLeaveAuditList.aspx.cs" Inherits="GKICMP.office.TraveLeaveAuditList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function auditainfo(e) {
            ...
            if (state == 1) {
                return openbox('A_id', 'TraveLeaveAuditEdit.aspx', 'id=' + id + '&lid=' + lid, 860, 350, 29);
            }
            else {
                alert("请选择未审核数据进行审核");
                return;
        ...
        function viewinfo(e) {
            var id = $(e).next().val();
            return openbox('A_id', 'TraveLeaveDetail.aspx', 'id=' + id, 950, 550, 4);
        }
    </script>
</head>
<body>
    <form runat="server">
        ...
        <div class="positionc">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td class="positiona"><a>首页</a><span>></span><asp:Label ID="lbl_ParentMenu" runat="server" Text=""></asp:Label><span>></span><asp:Label ID="lbl_Menuname" runat="server" Text="外出审核"></asp:Label>
                    </td>
                </tr>
            </table>
        </div>
        <div class="listcent searclass">
            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="10">
                <tbody>
                    <tr>
                        <td align="right" width="60">登记人：</td>
                        <td width="150">
                    ...
                    <asp:Repeater runat="server" ID="rp_List">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td>
                                    <div>
                                        <asp:LinkButton ID="lbtn_Audit" runat="server" CssClass="listbtn btneditcolor" ToolTip="审核" Visible='<%#Eval("AuditResult").ToString()=="1"?true:false %>' OnClientClick='return auditainfo(this);'>审核</asp:LinkButton>
                                ...
                                <%--  <td>
                                    <div>
                                        ...
                                        <asp:HiddenField ID="hf_PraType" Value='<%#Eval("LeaveState") %>' runat="server" />
                                    </div>
                                </td>--%>
                            </tr>
                        </ItemTemplate>
