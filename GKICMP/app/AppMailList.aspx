<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppMailList.aspx.cs" Inherits="GKICMP.app.AppMailList" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="mui-content">
            <div class="mui-content-padded" style="margin: 5px 0px;">
                <div class="search">
                    <asp:TextBox runat="server" ID="txt_Name" class="mui-input-clear" placeholder="请输入姓名/单位/手机号码"></asp:TextBox>
                            ...
                            <span>
                                <div class="mui-table">
                                    <div class="mui-table-cell mui-col-xs-10">
                                        ...
                                        <h4 class="mui-ellipsis color-2 mui-ellipsis"><span class="color-0" style="color:#48bd81; font-size:14px">[<%#Eval("DepName") %>]</span><%#Eval("RealName") %></h4>
                                        <p class="mui-h5 mui-ellipsis">
                                            <span>手机：<a href='tel://<%#Eval("CellPhone") %>'><%#Eval("CellPhone") %></a></span><span>&nbsp  QQ：<%#Eval("QQNum") %></span><br /><span>微信号：<%#Eval("WeiNum") %></span></p>
