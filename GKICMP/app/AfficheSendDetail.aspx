<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AfficheSendDetail.aspx.cs" Inherits="GKICMP.app.AfficheSendDetail" %>
...
<body>
    ...
    <li class="mui-table-view-cell litop">已读未读人员</li>
                <li class="mui-table-view-cell">
                    <div class="mui-col-xs-12">
                        <div class="xql"><b>已读</b><s></s></div>
                        <asp:Label ID="lbl_IsRead" runat="server" Text=""></asp:Label>
                    </div>
                </li>
                 <li class="mui-table-view-cell" style="color:red;">
                    <div class="mui-col-xs-12">
                        <div class="xql"><b>未读</b><s></s></div>
