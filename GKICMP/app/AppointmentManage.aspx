<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AppointmentManage.aspx.cs" Inherits="GKICMP.app.AppointmentManage" %>
...
<body>
    <form id="form1" runat="server">
        <header class="mui-bar mui-bar-nav">
            ...
            <h1 class="mui-title">场室管理</h1>
        </header>
        <div class="mui-content">
            <div style="padding: 10px 10px;">
                <div id="segmentedControl" class="mui-segmented-control">
                    <a href="AppointmentEdit.aspx" class="mui-control-item">场室预约</a>
                    <a href="AppointmentManage.aspx" class="mui-control-item mui-active">场室管理</a>
                </div>
            </div>
        ...
        <script>
            ...
            $.ajax({
                ...
                cache: false,
                type: "GET",
                data: "method=Appoint&pageindex=1&pagesize=10",
                dataType: "json",
                async: false,
                success: function (data) {
                    if (data.result == 'true') {
                        for (var j in data.data) {
                            ...
                            intem += "<h4>";
                            intem += "<span style='margin-left: -6px;'>" + "【" + data.data[j].MRName + "】" + data.data[j].AppUserName + "</span>";
                            intem += "</h4>";
                            intem += "<h5>";
                            intem += "<span style='margin-left:0px;'>" + data.data[j].BeginDate + "至" + data.data[j].EndDate;
                            intem += "</h5>";
                            intem += "<p>";
                            intem += data.data[j].AppointmentDesc;
                            intem += "</p>";
                            intem += "</div>";
                            intem += "</li>";
            ...
            function pullupRefresh() {
                setTimeout(function () {
                    ...
                    $.ajax({
                        ...
                        cache: false,
                        type: "GET",
                        data: "method=Appoint&pagesize=10&pageindex=" + i,
                        dataType: "json",
                        async: false,
                        success: function (data) {
                            if (data.result == 'true') {
