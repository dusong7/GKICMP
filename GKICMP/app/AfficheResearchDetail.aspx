<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AfficheResearchDetail.aspx.cs" Inherits="GKICMP.app.AfficheResearchDetail" %>
            ...
            <ul class="mui-table-view">
                 ...
                 <li class="mui-table-view-cell">
                    <div class="mui-col-xs-12">
                         <div class="xql"><b>教研类型</b><s></s></div>
                        <asp:Label ID="ltl_AType" runat="server" Text=""></asp:Label>
                    </div>
                </li>
                <li class="mui-table-view-cell">
                    <div class="mui-col-xs-12">
                         <div class="xql"><b>教研标题</b><s></s></div>
                ...
                <li class="mui-table-view-cell">
                 ...
                 <li class="mui-table-view-cell">
                    <div class="mui-col-xs-12">
                         <div class="xql"><b>教研内容</b><s></s></div>
                        <asp:Label ID="lbl_AContent" runat="server" Text=""></asp:Label>
                    </div>
                </li>


               <li class="mui-table-view-cell litop">参与人员</li>
               <%-- <li class="mui-table-view-cell">
                    <div class="mui-col-xs-12">
                        <asp:Label ID="lbl_IsRead" runat="server" Text=""></asp:Label>
                        <asp:Label ID="lbl_IsNotRead" runat="server" Text="" style="color:red;"></asp:Label>
                        <asp:Label ID="lbl_AuditMark" runat="server" ></asp:Label>
                    </div>
                </li>--%>
               
             <style>
                 .table1{width:100%;max-width:100%}
                 .table1 td{padding:12px 10px;min-width:100px;}
                 .table1 td span{white-space:normal;word-break:break-all;}
                     ...
                     <tbody>
                        <asp:Repeater runat="server" ID="rp_List">
                            <ItemTemplate>
                                    <tr>
                                      <td>
                                          <asp:Label ID="lbl_IsRead" runat="server" ><%#Eval("AcceptUserName")%> </asp:Label>
                                      </td>
                                        <td>
                                          <asp:Label ID="lbl_IsNotRead" runat="server" >
                                              <%--<%#Eval("IsRead").ToString() == "0" ? "不参与" : "参与"%>--%>
                                               <%#GetState(Eval("IsRead"),Eval("AuditMark") )%>

                                          </asp:Label>
                                        </td>
                                        <td> 
                                          <asp:Label ID="lbl_AuditMark" runat="server" ><%#Eval("AuditMark")%> </asp:Label>
                                      </td>
                                    </tr>
                            </ItemTemplate>
                        </asp:Repeater>
