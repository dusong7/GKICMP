<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AfficheResearchSend.aspx.cs" Inherits="GKICMP.app.AfficheResearchSend" %>
...
<body>
    <form id="form1" runat="server">
        <header class="mui-bar mui-bar-nav">
            ...
            <h1 class="mui-title">已发教研</h1>
        </header>
       <div class="mui-content">
            <div style="padding: 10px 10px;">
                <div id="segmentedControl" class="mui-segmented-control">
                     <a href="AfficheResearch.aspx" class="mui-control-item">教研活动</a>
                    <a href="AfficheResearchSend.aspx" class="mui-control-item mui-active">已发教研</a>
        ...
        <script>
            ...
            $.ajax({
                ...
                cache: false,
                type: "GET",
                data: "method=AfficheResearchSend&pageindex=1&pagesize=10",
                dataType: "json",
                async: false,
                success: function (data) {
                    for (var j in data.data) {
                        ...
                        intem += " <li class='mui-table-view-cell'><a href='AfficheResearchDetail.aspx?id=" + data.data[j].AID + "&&users=" + data.data[j].AcceptUser + "'> <div class='mui-table'><div class='mui-col-xs-12'><h4 class='mui-ellipsis'><span style='font-weight:lighter;color:#47AE6F'>[" + data.data[j].ATypeName + "]</span>"
                            ...
                            + "<h5>状态：" + (data.data[j].ReadOrNot == "0" ? "<span style='color:red'>有人不参与</span>" : "<span style='color:#48bd81'>全部参与</span>") + "</h5></div></div></a></li> ";
            ...
            function pullupRefresh() {
                setTimeout(function () {
                    ...
                    $.ajax({
                        ...
                        cache: false,
                        type: "GET",
                        data: "method=AfficheResearchSend&pagesize=10&pageindex=" + i,
                        dataType: "json",
                        async: false,
                        success: function (data) {
                            for (var j in data.data) {
