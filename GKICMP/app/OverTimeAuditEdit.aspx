<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OverTimeAuditEdit.aspx.cs" Inherits="GKICMP.app.OverTimeAuditEdit" %>
            ...
            <div class="mui-content-padded w100">
                ...
                <li class="mui-table-view-cell">
                    <div class="mui-col-xs-12">
                        申请人：<asp:Label ID="ltl_ApplyUser" runat="server" Text=""></asp:Label>
                    </div>
                </li>
                <li class="mui-table-view-cell">
                    <div class="mui-col-xs-12">
                        类型：<asp:Label ID="ltl_OType" runat="server" Text=""></asp:Label>
                    </div>
                </li>
                <li class="mui-table-view-cell">
                    <div class="mui-col-xs-12">
                        开始日期：<asp:Literal runat="server" ID="ltl_BeginDate"></asp:Literal>
                    </div>
                </li>
                <li class="mui-table-view-cell">
                    <div class="mui-col-xs-12">
                        结束日期：<asp:Label ID="ltl_EndDate" runat="server" Text=""></asp:Label>
                    </div>
                </li>
                <li class="mui-table-view-cell">
                    <div class="mui-col-xs-12">
                        参与人：<asp:Label ID="ltl_UsersName" runat="server" Text=""></asp:Label>
                    </div>
                </li>
                <li class="mui-table-view-cell">
                    <div class="mui-col-xs-12">
                        加班时长：<asp:Label ID="ltl_ODays" runat="server" Text=""></asp:Label>
                    </div>
                </li>
              
                <li class="mui-table-view-cell">
                    <div class="mui-col-xs-12">
                        加班事由：<asp:Label ID="ltl_OMark" runat="server" Text=""></asp:Label>
                    </div>
                </li>
               <li class="mui-table-view-cell">
                    <div class="mui-col-xs-12">
                        状态：<asp:Label ID="ltl_OState" runat="server" Text=""></asp:Label>
                    </div>
                </li>
