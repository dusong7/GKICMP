<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PersonRewardDetail.aspx.cs" Inherits="GKICMP.app.PersonRewardDetail" %>
...
<body>
    <form id="form1" runat="server" class="mui-input-group">
     ...
     <%--  <li class="mui-table-view-cell litop">奖励信息</li>--%>
                ...
                <li class="mui-table-view-cell">
                    <div class="mui-col-xs-12">
                        <div class="xql"><b>授奖单位</b><s></s></div>
                        <asp:Label ID="lbl_Lunit" runat="server" Text=""></asp:Label>
                    </div>
                </li>
                <li class="mui-table-view-cell">
                    <div class="mui-col-xs-12">
                        <div class="xql"><b>奖励类别</b><s></s></div>
                        <asp:Label ID="lbl_RewardType" runat="server" Text=""></asp:Label>
                    </div>
                </li>
                <li class="mui-table-view-cell">
                    <div class="mui-col-xs-12">
                ...
                <li class="mui-table-view-cell">
                    <div class="mui-col-xs-12">
                        <div class="xql"><b>奖励级别</b><s></s></div>
                        <asp:Label ID="lbl_RGrade" runat="server" Text=""></asp:Label>
                    </div>
                </li>
                <li class="mui-table-view-cell">
                    <div class="mui-col-xs-12">
                        <div class="xql"><b>本人排名</b><s></s></div>
                        <asp:Label ID="lbl_Ranking" runat="server" Text=""></asp:Label>
                    </div>
                </li>
                
                <li class="mui-table-view-cell">
                    <div class="mui-col-xs-12">
                        <div class="xql"><b>是否上报</b><s></s></div>
                        <asp:Label ID="lbl_Report" runat="server" Text=""></asp:Label>
                    </div>
                </li>
