<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AlreadyEgovernmentManage.aspx.cs" Inherits="GKICMP.app.AlreadyEgovernmentManage" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="mui-content">
            <div style="padding: 10px 10px;">
                <div id="segmentedControl" class="mui-segmented-control">
                    <a href="TreatedEgovernmentManage.aspx" class="mui-control-item">待处理政务</a>
                    <a href="AlreadyEgovernmentManage.aspx" class="mui-control-item mui-active">已发政务</a>
        ...
        <script>
            ...
            $.ajax({
                ...
                cache: false,
                type: "GET",
                data: "method=yf&pageindex=1&pagesize=10&didname=" + $("#hf_didname").val(),
                //data: "method=EgovernmentByFlag&flag=2&pageindex=1&pagesize=10&didname=" + $("#hf_didname").val(),
                dataType: "json",
                async: false,
                success: function (data) {
                    if (data.result == "success") {
                        for (var j in data.data) {
                            var intem = "";
                            intem += " <li class='mui-table-view-cell'><a href='EgovernmentDetails.aspx?id=" + data.data[j].FID + "&flag=1'> <div class='mui-table'><div class='mui-col-xs-12'><h4 class='mui-ellipsis'> "
                                ...
                                + "<h5>收件人：" + data.data[j].AcceptUserName + "&nbsp&nbsp&nbsp&nbsp<span>状态: "
            ...
            function pullupRefresh() {
                setTimeout(function () {
                    ...
                    $.ajax({
                        ...
                        cache: false,
                        type: "GET",
                        data: "method=EgovernmentByFlag&flag=2&pagesize=10&pageindex=" + i + "&didname=" + $("#hf_didname").val(),
...
<script>
    function getdata(name) {
        $.ajax({
            ...
            cache: false,
            type: "GET",
            data: "method=EgovernmentByFlag&flag=2&pageindex=1&pagesize=10&didname=" + name,
            dataType: "json",
            async: false,
            success: function (data) {
                if (data.result == "success") {
