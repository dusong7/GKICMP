<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LeaveRecordDetail.aspx.cs" Inherits="GKICMP.app.LeaveRecordDetail" %>
...
<body>
    <form id="form1" runat="server" class="mui-input-group">
       ...
       <li class="mui-table-view-cell litop">备案信息</li>
