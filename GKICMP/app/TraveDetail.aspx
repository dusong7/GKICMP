<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TraveDetail.aspx.cs" Inherits="GKICMP.app.TraveDetail" %>
...
<body>
    <form id="form1" runat="server" class="mui-input-group">
       ...
       <li class="mui-table-view-cell litop">外出信息</li>
                <li class="mui-table-view-cell">
                    <div class="mui-col-xs-12">
                        <div class="xql"><b>外出人</b><s></s></div>
                        <asp:Label ID="lbl_LeaveUser" runat="server" Text=""></asp:Label>
                    </div>
                </li>
                <li class="mui-table-view-cell">
                    <div class="mui-col-xs-12">
                        <div class="xql"><b>外出天数</b><s></s></div>
                ...
                <li class="mui-table-view-cell">
                    <div class="mui-col-xs-12">
                        <div class="xql"><b>外出事由</b><s></s></div>
                            ...
                            <ItemTemplate>
                                <li style="height:auto">
                                    <span style="max-width: 100%; width: 100%;font-size:12px;">
                                        <%-- <%#Eval("RealName").ToString().Split(',').Length>1?Eval("AuditResult").ToString()!="1"? (Eval("AuditName")+"   审核"):"":Eval("RealName")%>
