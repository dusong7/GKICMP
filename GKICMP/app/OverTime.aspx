<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OverTime.aspx.cs" Inherits="GKICMP.app.OverTime" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="mui-content">
            <div style="padding: 10px 10px;">
                ...
                <a href="OverTime.aspx" class="mui-control-item mui-active">我发起的</a>
        ...
        <script>
            ...
            $.ajax({
                ...
                cache: false,
                type: "GET",
                data: "method=OverTime&pageindex=1&pagesize=10",
                dataType: "json",
                async: false,
            ...
            function pullupRefresh() {
                setTimeout(function () {
                    ...
                    $.ajax({
                        ...
                        cache: false,
                        type: "GET",
                        data: "method=OverTime&pagesize=10&pageindex=" + i,
