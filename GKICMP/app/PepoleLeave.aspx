<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PepoleLeave.aspx.cs" Inherits="GKICMP.app.PepoleLeave" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="mui-content">
            <div style="padding: 10px 10px;">
                <div id="segmentedControl" class="mui-segmented-control">
                    ...
                    <a href="PepoleLeave.aspx" class="mui-control-item mui-active">我发起的</a>
        ...
        <script>
            ...
            $.ajax({
                ...
                cache: false,
                type: "GET",
                data: "method=PeopleLeave&pageindex=1&pagesize=10",
                dataType: "json",
                async: false,
            ...
            function pullupRefresh() {
                setTimeout(function () {
                    ...
                    $.ajax({
                        ...
                        cache: false,
                        type: "GET",
                        data: "method=PeopleLeave&pagesize=10&pageindex=" + i,
