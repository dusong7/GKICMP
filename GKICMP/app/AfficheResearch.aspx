<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AfficheResearch.aspx.cs" Inherits="GKICMP.app.AfficheResearch" %>
        ...
        <div class="mui-content">
             ...
             <div style="padding: 10px 10px;">
                <div id="segmentedControl" class="mui-segmented-control">
                    <a href="AfficheResearch.aspx" class="mui-control-item mui-active">教研活动</a>
                    <a href="AfficheResearchSend.aspx" class="mui-control-item">已发教研</a>
                    <a href="AfficheResearchAccept.aspx" class="mui-control-item">已收教研</a>
                </div>
            </div>
            ...
            <div class="mui-content-padded w100">
                <div class="mui-input-group linght40">
                    <div class="mui-input-row">
                        <label>教研主题</label>
                        <asp:TextBox ID="txt_AfficheTitle" runat="server" CssClass="mui-icon-location" placeholder="请填写教研主题"></asp:TextBox>
                    </div>
                </div>
...
<%--               <div class="mui-input-group linght40">
                    <div class="mui-input-row">
                        <label>教研类型</label>
                        <asp:TextBox runat="server" name="showType" ID="txt_AType" placeholder="请选择教研类型"></asp:TextBox>
                ...
                <div class="mui-input-group linght40">
                    <div class="mui-input-row">
                        <label>参与人员</label>
                        <input type="text" id="dxseclet" name="dxseclet" placeholder="点击此处选择参与人员"/>
                ...
                <div class="textarea-div">
                    <div class="mui-input-group hybt linght40">
                        <p>教研内容</p>
                        <asp:TextBox ID="txt_AContent" TextMode="MultiLine" runat="server" MaxLength="200" Rows="3" placeholder="请在此填写教研内容"></asp:TextBox>
                    </div>
                </div>
