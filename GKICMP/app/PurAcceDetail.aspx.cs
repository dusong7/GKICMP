...
{
    public partial class PurAcceDetail : PageBaseApp
    {
        ...
        private void InfoBind()
        {
            ...
            if (model != null)
            {
                this.lbl_PName.Text = model.PName.ToString();
                //this.ltl_Evaluate.Text = model.Evaluate.ToString() + "年";
                this.lbl_Evaluate.Text = CommonFunction.CheckEnum<CommonEnum.ProjectCheck>(model.Evaluate.ToString());
                this.lbl_PCDate.Text = model.PCDate.ToString() == "0001/1/1 0:00:00" ? "" : model.PCDate.ToString("yyyy-MM-dd");
                this.lbl_Opinion.Text = model.Opinion.ToString();
