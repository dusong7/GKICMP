<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AfficheAcceptManage.aspx.cs" Inherits="GKICMP.app.AfficheAcceptManage" %>
       ...
       <div class="mui-content">
            <div style="padding: 10px 10px;">
                <div id="segmentedControl" class="mui-segmented-control">
                     ...
                     <a href="AfficheAcceptManage.aspx" class="mui-control-item mui-active">已收通知</a>
                </div>
            </div>
            <div class="mui-input-row mui-search" style="margin-top: 0px">
                <input type="search" class="mui-input-clear" placeholder="请输入通知" id="keyword" />
            </div>
        ...
        <script>
            ...
            $.ajax({
                ...
                cache: false,
                type: "GET",
                data: "method=Affiche&pageindex=1&pagesize=10",
                dataType: "json",
                async: false,
                success: function (data) {
                    for (var j in data.data) {
                        var intem = "";
                        intem += " <li class='mui-table-view-cell'><a href='AfficheDetail.aspx?id=" + data.data[j].AID + "&&users=" + data.data[j].AcceptUser + "'> <div class='mui-table'><div class='mui-col-xs-12'><h4 class='mui-ellipsis'><span style='font-weight:lighter;color:#47AE6F'>[" + data.data[j].ATypeName + "]</span>"
                            ...
                            + "&nbsp&nbsp&nbsp&nbsp状态：" + (data.data[j].IsRead == "0" ? "<span style='color:red'>未读</span>" : "<span style='color:#48bd81'>已读</span>") + "</h5></div></div></a></li> ";
            ...
            function pullupRefresh() {
                setTimeout(function () {
                    ...
                    $.ajax({
                        ...
                        cache: false,
                        type: "GET",
                        data: "method=Affiche&pagesize=10&pageindex=" + i,
                        dataType: "json",
                        async: false,
                        success: function (data) {
                            for (var j in data.data) {
