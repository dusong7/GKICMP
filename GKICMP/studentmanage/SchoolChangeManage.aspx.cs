...
{
    public partial class SchoolChangeManage : PageBase
    {
        ...
        public void DataBindList()
        {
            ...
            model.AduitState = -2;
            DataTable dt = schoolChangeDAL.GetPaged(Pager.PageSize, Pager.CurrentPageIndex, ref recordCount, model, begin, end,1);
