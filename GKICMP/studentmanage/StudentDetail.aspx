<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentDetail.aspx.cs" Inherits="GKICMP.studentmanage.StudentDetail" %>
                ...
                <tbody>
                    ...
                    <th align="left" colspan="4">
                        <div class="xxsm" style="padding-left: 15px">
                            <ul>
                                <li class="selected"><a href="StudentDetail.aspx?id=<%=UID %>">基本信息</a></li>
                                <li ><a href="StudentElderDetail.aspx?id=<%=UID %>">家庭信息</a></li>
                            </ul>
                        </div>
                    </th>
                </tr>
                    ...
                    <tr>
                     ...
                     <tr>
                        <td style="text-align: center" colspan="4">
                            ...
                            <input type="button" name="button" id="cancell" value="返回" class="editor" onclick='javascript: window.location.href = "StudentManage.aspx";' />
                        </td>
                     </tr>
