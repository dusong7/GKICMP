<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentEdit.aspx.cs" Inherits="GKICMP.studentmanage.StudentEdit" %>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="listinfo">
                <tbody>
                        ...
                        <th colspan="4" align="left">
                            <div class="xxsm">
                                <ul>
                                    ...
                                    <li class="selected"><a href="StudentEdit.aspx?ID=<%=UID %>">基本信息</a></li>
                                    <li><a href="StudentElderManage.aspx?ID=<%=UID %>">家庭信息</a></li>
                                </ul>
                            </div>
                        </th>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="txt_LoinDate" runat="server" onclick="WdatePicker({skin:'whyGreen'})"></asp:TextBox>
                        </td>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox ID="txt_PEnrollment" runat="server" Width="400px"></asp:TextBox></td>
                    ...
                    <tr>
                        ...
                        <td align="left" colspan="3">
                            <asp:TextBox ID="txt_GEnrollment" runat="server" Width="400px"></asp:TextBox></td>
                    </tr>
                    <tr>
