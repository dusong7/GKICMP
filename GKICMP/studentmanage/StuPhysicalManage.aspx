<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StuPhysicalManage.aspx.cs" Inherits="GKICMP.studentmanage.StuPhysicalManage" %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#btn_Import').click(function () {
                return openbox('A_id', 'StuPhysicalImport.aspx', '', 700, 280, -1);
            });
        });
        function editinfo(e) {
            var id = $(e).next().val();
           ...
           <div class="positionc">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td class="positiona"><a>首页</a><span>></span><asp:Label ID="lbl_ParentMenu" runat="server" Text=""></asp:Label><span>></span><asp:Label ID="lbl_Menuname" runat="server" Text="体质健康管理"></asp:Label>
                    </td>
                </tr>
            </table>
        </div>
            ...
            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="10">
                <tbody>
                    <tr>
                        ...
                        <td width="150">
                            <asp:TextBox ID="txt_StuName" runat="server"></asp:TextBox>
                        </td>
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td >
                                        ...
                                        <asp:HiddenField ID="hf_SelectID" Value='<%#Eval("SPID") %>' runat="server" />
                                        ...
                                        <asp:HiddenField ID="hf_TPID" Value='<%#Eval("SPID") %>' runat="server" />
                                </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
