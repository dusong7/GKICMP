<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SchoolChangeManage.aspx.cs" Inherits="GKICMP.studentmanage.SchoolChangeManage" %>
                        ...
                        <ItemTemplate>
                            <tr>
                              ...
                              <%--  <td><%# Eval("ClaIDName")%></td>--%>
                                ...
                                <td>
                                    <asp:LinkButton ID="lbtn_Edit" runat="server" CssClass="listbtn btneditcolor" Visible='<%#Eval("AduitState").ToString()=="1"?true:false %>' ToolTip="编辑" OnClientClick='return editinfo(this);'>编辑</asp:LinkButton>
