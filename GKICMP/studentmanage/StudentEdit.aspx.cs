...
{
    public partial class StudentEdit : PageBase
    {
        ...
        {
            if (ddl_pid.SelectedItem.Text != "进城务工人员随迁子女")
            {
            ...
            else
            {
                ...
                DataTable dt1 = baseDataDAL.GetList((int)CommonEnum.BaseDataType.流动人口, Convert.ToInt32(this.ddl_pid.SelectedValue));
        ...
        public void DdlBind()
        {
            ...
            DataTable dt1 = baseDataDAL.GetList((int)CommonEnum.BaseDataType.流动人口, -1);
            CommonFunction.DDlTypeBind(this.ddl_pid, dt1, "SDID", "DataName", "-2");
        ...
        public void BindInfo()
        {
            ...
            if (model1 != null)
            {
                this.ddl_Usuate.SelectedValue = model1.UState.ToString();
                this.txt_CardNum.Text = model1.CardNum;
                this.txt_CellPhone.Text = model1.CellPhone;
                this.txt_EntranceDate.Text = model1.EnterDate.ToString("yyyy-MM-dd") == "0001-01-01" ? "" : model1.EnterDate.ToString("yyyy-MM-dd") == "1900-01-01" ? "" : model1.EnterDate.ToString("yyyy-MM-dd");
                ...
                this.txt_LoinDate.Text = model1.LoinDate.ToString("yyyy-MM-dd") == "0001-01-01" ? "" : model1.LoinDate.ToString("yyyy-MM-dd") == "1900-01-01" ? "" : model1.LoinDate.ToString("yyyy-MM-dd");
                ...
                if (Convert.ToInt32(model1.IsFlow) > 328)
                {
                    this.ddl_IsFlow.Visible = true;
                    this.ddl_pid.SelectedValue = "327";
                    DataTable dt1 = baseDataDAL.GetList((int)CommonEnum.BaseDataType.流动人口, 327);
                    CommonFunction.DDlTypeBind(this.ddl_IsFlow, dt1, "SDID", "DataName", "-999");
        ...
        protected void btn_Sumbit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                model.IsFlow = this.ddl_pid.SelectedItem.Text == "进城务工人员随迁子女" ? this.ddl_IsFlow.SelectedValue : this.ddl_pid.SelectedValue;
                ...
                model.LoinDate = Convert.ToDateTime(this.txt_LoinDate.Text == "" ? "1900-01-01" : this.txt_LoinDate.Text);
