<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StuPhysicalImport.aspx.cs" Inherits="GKICMP.studentmanage.StuPhysicalImport" %>
        ...
        <div class="listcent pad0">
            <div>
                <table width="100%" cellspacing="0" cellpadding="0" class="listinfo1">
                    <tr>
                        <th colspan="4" align="left">体质健康信息
                        </th>
                    </tr>
                    <tr>
                        <td align="right" width="100px">体质健康信息：</td>
                        <td>
