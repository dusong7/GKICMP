<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InvoicePersonManage.aspx.cs" Inherits="GKICMP.invoice.InvoicePersonManage" %>
        ...
        <div class="positionc">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td class="positiona"><a>首页</a><span>></span><asp:Label ID="lbl_ParentMenu" runat="server" Text=""></asp:Label><span>></span><asp:Label ID="lbl_Menuname" runat="server" Text="报销管理"></asp:Label>
                    </td>
                </tr>
            </table>
        </div>
                            ...
                            <tr>
                                <td style="width: 5px">
                                    <label class="wxz" id='ck_<%#Eval("IID")%>l'>
                                        <input type="checkbox" name="checkbox" onclick="setid(this.id)" value='<%#Eval("IID") %>' id='ck_<%#Eval("IID") %>' <%#Eval("IState").ToString()=="2"?"disabled":"" %> /></label>
                                </td>
                                ...
                                <td>
                                    <div>
                                        <asp:LinkButton ID="lbtn_Edit" runat="server" CssClass="listbtn btneditcolor" Visible='<%#Eval("IState").ToString()=="2"?false:true %>' OnClientClick="return editinfo(this);">编辑</asp:LinkButton>
