...
{
    public partial class InvoiceManage : PageBase
    {
        ...
        private void DataBindList()
        {
            ...
            DataTable dt = invoiceDAL.GetPaged(Pager.PageSize, Pager.CurrentPageIndex, ref recordCount, model, Convert.ToDateTime(ViewState["BeginDate"].ToString()), Convert.ToDateTime(ViewState["EndDate"].ToString()), 3, (string)ViewState["UserName"]);
