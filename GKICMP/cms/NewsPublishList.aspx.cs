...
{
    public partial class NewsPublishList : PageBase
    {
        ...
        private void DataBindList()
        {
            ...
            if (Flag != 2)
                model.Nstate = (int)CommonEnum.IsorNot.否;
            else
                model.Nstate = -2;
            DataTable dt = web_NewsDAL.GetNewsPublishPaged(Pager.PageSize, Pager.CurrentPageIndex, ref recordCount, model);
