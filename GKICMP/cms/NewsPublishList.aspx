<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewsPublishList.aspx.cs" Inherits="GKICMP.cms.NewsPublishList" %>
        ...
        <div class="positionc">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td class="positiona"><a>首页</a><span>></span><asp:Label ID="lbl_ParentMenu" runat="server" Text="网站管理"></asp:Label><span>></span><asp:Label ID="lbl_Menuname" runat="server" Text="文章发布"></asp:Label>
                    </td>
                </tr>
            </table>
        </div>
                    ...
                    <th colspan="7" align="left" style="padding-left: 15px">
                        <div class="xxsm">
                            <ul>
                                ...
                                <li id="selected" class="selected"><a href="NewsPublishList.aspx?flag=1">文章发布</a></li>
                                <li id="select"><a href="NewsPublishList.aspx?flag=2">全部文章</a></li>
                            </ul>
                        </div>
                    </th>
                </tr>
                            ...
                            <tr>
                                <td style="width: 5px">
                                    <label class="wxz" id='ck_<%#Eval("NID")%>l'>
                                        ...
                                        <input type="checkbox" name="checkbox" onclick="setid(this.id)" value='<%#Eval("NID") %>' id='ck_<%#Eval("NID") %>' <%#Eval("NState").ToString()=="0"?"":"disabled" %> /></label>
                                </td>
