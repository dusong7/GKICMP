<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewsManage.aspx.cs" Inherits="GKICMP.cms.NewsManage" %>
        ...
        <div class="positionc">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td class="positiona"><a>首页</a><span>></span><asp:Label ID="lbl_ParentMenu" runat="server" Text=""></asp:Label><span>></span><asp:Label ID="lbl_Menuname" runat="server" Text="新闻管理"></asp:Label>
                    </td>
                </tr>
            </table>
        </div>
                        ...
                        <ItemTemplate>
                            <tr>
                               ...
                               <%-- <td><%#Eval("NewsTitle")%></td>--%>
                                ...
                                <td>
                                        <asp:LinkButton ID="lbtn_Edit" runat="server" CssClass="listbtn btneditcolor" ToolTip="编辑" CommandArgument='<%#Eval("NID") %>' OnClick="lbtn_Edit_Click">编辑</asp:LinkButton>
