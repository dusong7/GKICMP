...
{
    public partial class NewsListOfMine : PageBase
    {
        ...
        {
            string aa = string.Format("<script language=javascript>window.open('NewsEdit.aspx?id={0}&flag=2', '_self')</script>", "");
            Response.Write(aa);
        }
        #endregion
        ...
        protected void lbtn_Edit_Click(object sender, EventArgs e)
        {
            ...
            string aa = string.Format("<script language=javascript>window.open('NewsEdit.aspx?id={0}&flag=2', '_self')</script>", id);
            Response.Write(aa);
        }
        #endregion
        ...
        protected void lbtn_Detail_Click(object sender, EventArgs e)
        {
            LinkButton lbtn = (LinkButton)sender;
            string id = lbtn.CommandArgument.ToString();
            string aa = string.Format("<script language=javascript>window.open('NewsDetail.aspx?id={0}&flag=2','_self')</script>", id);
            Response.Write(aa);
        }
        #endregion
        //#region 详情
