<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NetworkTeachEdit.aspx.cs" Inherits="GKICMP.networkteach.NetworkTeachEdit" %>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="listinfo">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td >
                             <div id="more">
                                 <%--onchange="if(this.value)judgepic(this.value,this);"--%>
                                <asp:FileUpload ID="fl_UpFile" onchange="if(this.value)judgemp(this.value,this);" runat="server"  />
                            </div>
                            <asp:HiddenField ID="hf_UpFile" runat="server" />
                            <asp:HiddenField ID="hf_UpImage" runat="server" />
                        </td>
                    </tr>
                    <tr>
