<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NetworkTeachManage.aspx.cs" Inherits="GKICMP.networkteach.NetworkTeachManage" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function editinfo(e) {
            var id = $(e).next().val();
            return openbox('A_id', 'NetworkTeachQuote.aspx', 'id=' + id, 700, 500, 0);
        }

        function viewinfo(e) {
            var id = $(e).next().val();
            return openbox('A_id', 'NetworkTeachDetail.aspx', 'id=' + id, 960, 400, 54);
        }
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <asp:LinkButton ID="lbtn_WatchOnline" runat="server" CssClass="listbtn btnqxcolor" ToolTip="在线学习" CommandName='<%#Eval("NRID")+","+Eval("IsCommunication")%>'  CommandArgument='<%#Eval("NTID") %>' OnClick="lbtn_WatchOnline_Click">在线学习</asp:LinkButton>
                                     <asp:LinkButton ID="lbtn_Quote" runat="server" CssClass="listbtn btnsubcolor" ToolTip="引用视频"   OnClientClick='return editinfo(this);'>引用视频</asp:LinkButton>
                                    <asp:HiddenField runat="server" ID="HiddenField1" Value='<%#Eval("NTID") %>' />
