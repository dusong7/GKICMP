...
{
    public partial class NetworkTeachManageTea : PageBase
    {
        ...
        private void DataBindList()
        {
            ...
            DataTable dt = networkTeachDAL.GetPagedByTea(Pager.PageSize, Pager.CurrentPageIndex, ref recordCount, model);
