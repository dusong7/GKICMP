<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PerformanceStandard.aspx.cs" Inherits="GKICMP.performance.PerformanceStandard" %>
    ...
    <script type="text/javascript">
        $(function () {
            $('#btn_Add').click(function () {
                ...
                var pfid = document.getElementById("hf_PFID").value;
                return openbox('A_id', '../lecturemanage/LectureStandardEdit.aspx', 'pfid=' + pfid + '&flag=0&type=2', 860, 420, -1);//pfid考核标准ID
            });
        });
        function showbox(id) {
            //var id = $(e).next().next().val();
            return openbox('A_id', '../lecturemanage/LectureStandardEdit.aspx', 'pid=' + id + '&flag=0&type=2', 860, 420, -1);//type:1：听课标准 2：考核标准
        }

        function editinfo(id) {
            return openbox('A_id', '../lecturemanage/LectureStandardEdit.aspx', 'id=' + id + '&flag=1&type=2', 860, 420, 0);//type:1：听课标准 2：考核标准
        }
...
<body style="background-color: #f5f5f5;">
    ...
    <form id="form1" runat="server">
        ...
        <asp:HiddenField runat="server" ID="hf_PFID" />
        ...
        <%--<div style="line-height: 26px; width: 98%; margin: auto; margin-top: 15px; font-size: 12px; font-family: 微软雅黑体; background: #f5f5f5;">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td class="positiona"><a>首页</a><span>></span><asp:Label ID="lbl_ParentMenu" runat="server" Text=""></asp:Label><span>></span><asp:Label ID="lbl_Menuname" runat="server" Text="考核标准"></asp:Label>
                    </td>
                </tr>
            </table>
        </div>--%>
