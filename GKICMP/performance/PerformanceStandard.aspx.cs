...
{
    public partial class PerformanceStandard : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                this.hf_PFID.Value = PFID.ToString();
        ...
        private string GetTableContent()
        {
            ...
            DataTable dtFirst = standardDAL.GetListByPFID((int)CommonEnum.Deleted.未删除, -2, 2, PFID);//获取第一标准 1：听课标准 2：考核标准
 ...
 font-size: 14px;' onclick='jQuery(&#39;#example-advanced&#39;).treetable(&#39;collapseAll&#39;); return false;'>&nbsp;全部收起&nbsp;</a>");
        ...
        {
            StringBuilder sb = new StringBuilder("");
            DataTable dv = standardDAL.GetList((int)CommonEnum.Deleted.未删除, parentid, 2);//1：听课标准 2：考核标准
            if (dv.Rows.Count > 0)
            {
