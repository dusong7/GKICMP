<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AfficheClassEdit.aspx.cs" Inherits="GKICMP.oamanage.AfficheClassEdit" %>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="listinfo">
                <tbody>
                    ...
                    <tr id="aa" runat="server">
                        <td align="right" width="120">收件人：</td>
                        <td align="left" >
                            ...
                            <input id="Series" onlyleafcheck="true" multiple="true" multiline="true" name="Series" style="width: 70%; height: 80px" class="easyui-combotree" url="../ashx/EUIDataList.ashx?method=GList&IsChild=true&IsRE=true&IsUser=false&IsDuty=true&Flag=<%=Flag%>" />
                        </td>
                    </tr>
                    <tr>
                        <td align="right" width="120">通知内容：</td>
                        <td align="left" >
                            <asp:TextBox ID="txt_AContent" runat="server" datatype="*" nullmsg="请输入公告内容" Width="70%" CssClass="searchbg" Style="resize: none" TextMode="MultiLine" Columns="6" Height="150px"></asp:TextBox><span style="color: Red; float: none">*</span></td>
