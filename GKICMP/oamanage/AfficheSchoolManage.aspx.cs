...
{
    public partial class AfficheSchoolManage : PageBase
    {
        ...
        public void DataBindList()
        {
            ...
            DataTable dt = afficheDAL.GetPagedSchool(Pager.PageSize, Pager.CurrentPageIndex, ref recordCount, model, begin, end,0);
        ...
        {
            string aa = string.Format("<script language=javascript>window.open('AfficheSchoolEdit.aspx', '_self')</script>");
            Response.Write(aa);
        }
        #endregion
    }
