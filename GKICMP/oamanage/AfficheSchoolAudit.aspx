<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AfficheSchoolAudit.aspx.cs" Inherits="GKICMP.oamanage.AfficheSchoolAudit" %>
        ...
        <div class="positionc">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td class="positiona"><a>首页</a><span>></span><asp:Label ID="lbl_ParentMenu" runat="server" Text="通知公告"></asp:Label><span>></span><asp:Label ID="lbl_Menuname" runat="server" Text="全体公告"></asp:Label>
                    </td>
                </tr>
            </table>
        </div>
                            ...
                            <tr>
                              <%--  <td><%#Eval("AtypeName")%></td>--%>
                                ...
                                <td><%#Eval("SendDate","{0:yyyy-MM-dd HH:mm}")%></td>
                                 <td title='<%#Eval("AContent")%>'><%#GetCutStr(Eval("AContent"),30)%></td>
                                ...
                                <td>
                                    <div>
                                        ...
                                        <asp:LinkButton ID="lbtn_Detail" runat="server" CssClass=" listbtn btndetialcolor" CommandArgument='<%#Eval("AID") %>' CommandName="全员" ToolTip="详细" OnClick="lbtn_View_Click">审核</asp:LinkButton>
                                    </div>
                                </td>
                            </tr>
                        </ItemTemplate>
