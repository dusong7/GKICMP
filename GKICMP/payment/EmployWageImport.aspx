<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployWageImport.aspx.cs" Inherits="GKICMP.payment.EmployWageImport" %>
        ...
        <div class="listcent pad0">
            <div>
                <table width="100%" cellspacing="0" cellpadding="0" class="listinfo1">
                    <tr>
                        <th colspan="4" align="left">聘用工资导入
                        </th>
                    </tr>
                    <tr>
                        <td align="right">聘用工资信息：</td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <span style="color: red;">1.请先下载导入模板并严格按照导入模板录入数据进行导入；<br />
                                2.用户名必须是系统中已存在的用户否则导入不进去； </span></td>
                    </tr>
                    <tr>
