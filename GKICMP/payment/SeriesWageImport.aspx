<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SeriesWageImport.aspx.cs" Inherits="GKICMP.payment.SeriesWageImport" %>
        ...
        <div class="listcent pad0">
            <div>
                <table width="100%" cellspacing="0" cellpadding="0" class="listinfo1">
                    <tr>
                        <th colspan="4" align="left">在编工资导入
                        </th>
                    </tr>
                    <tr>
                        <td align="right">在编工资信息：</td>
                        <td>
