<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HomeworkManage.aspx.cs" Inherits="GKICMP.studentpage.HomeworkManage" %>
        ...
        <div class="positionc">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td class="positiona"><a>首页</a><span>></span>我的日常<span>></span>我的作业
                    </td>
                </tr>
            </table>
        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div>
                                        ...
                                        <asp:LinkButton ID="lbtn_Detail" runat="server" CssClass="listbtn btndetialcolor" Visible='<%#Convert.ToInt32(Eval("IsSend"))==1?false:true %>' OnClientClick='return viewinfo(this);'>详情</asp:LinkButton>
