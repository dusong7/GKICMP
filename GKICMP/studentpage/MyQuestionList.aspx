<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MyQuestionList.aspx.cs" Inherits="GKICMP.studentpage.MyQuestionList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function addinfo(e) {
            var id = $(e).next().val();
            return openbox('A_id', 'MyQuestionEdit.aspx', 'id=' + id, 960, 720, 51);
        }
    </script>
</head>
<body>
