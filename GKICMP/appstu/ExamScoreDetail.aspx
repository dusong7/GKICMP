<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExamScoreDetail.aspx.cs" Inherits="GKICMP.appstu.ExamScoreDetail" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <header class="mui-bar mui-bar-nav">
            ...
            <h1 class="mui-title">
                <asp:Literal runat="server" ID="ltl_ExamName"></asp:Literal></h1>
        </header>
        <div id="page-wrapper">
            <div class="main-page">
                <div class="tables">
                    <div class="bs-example widget-shadow" data-example-id="bordered-table">
                        <asp:Literal runat="server" ID="ltl_Header"></asp:Literal>
                    </div>
                </div>
            </div>
        </div>
