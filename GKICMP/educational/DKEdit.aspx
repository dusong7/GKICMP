<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DKEdit.aspx.cs" Inherits="GKICMP.educational.DKEdit" %>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="listinfo">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:TextBox runat="server" ID="txt_BeginTime" Width="155px" datatype="*" nullmsg="请填写调课开始时间" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})"></asp:TextBox>--
                            <asp:TextBox runat="server" ID="txt_EndTime" Width="155px" datatype="*" nullmsg="请填写调课结束时间" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})"></asp:TextBox>
