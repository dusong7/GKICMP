<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CourseManage.aspx.cs" Inherits="GKICMP.educational.CourseManage" %>
        ...
        <div class="positionc">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td class="positiona"><a>首页</a><span>></span><asp:Label ID="lbl_ParentMenu" runat="server" Text=""></asp:Label><span>></span><asp:Label ID="lbl_Menuname" runat="server" Text="课程管理"></asp:Label>
                    </td>
                </tr>
            </table>
        </div>
            ...
            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="10">
                <tbody>
                    <tr>
                        ...
                        <td width="150">
                            <asp:TextBox ID="txt_CourseName" Text="" runat="server"></asp:TextBox>
                        </td>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="listinfo">
                <tbody>
                    <tr>
                        ...
                        <th align="center">是否开设</th>
                        <th align="center">教材册数</th>
                        <th align="center">教材版本数</th>
                        <th align="center">课程等级</th>
                        <th align="center">是否主课</th>
                         <th align="center">是否选修课</th>
                    ...
                    <asp:Repeater runat="server" ID="rp_List">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td><%#Eval("IsOpen").ToString()=="1"?"是":"否"%></td>
                                <td><%#Eval("MaterialNum")%></td>
                                <td><%#Eval("EditionNum")%></td>
                                <td><%#GK.GKICMP.Common.CommonFunction.CheckEnum<GK.GKICMP.Common.CommonEnum.CourseGrade>(Eval("CourseGrade")) %></td>
                                <td><%#Eval("IsMain").ToString()=="1"?"是":"否"%></td>
                                    <td><%#Eval("IsElective").ToString()=="1"?"是":"否"%></td>
                                ...
                                <td>
                                        <asp:LinkButton ID="lbtn_IsOpen"  runat="server" CssClass="listbtn btnkskccolor" ToolTip='<%#Eval("IsOpen").ToString()=="1"?"取消开设":"开设课程" %>' CommandArgument='<%#Eval("CID") %>' OnClick="lbtn_IsOpen_Click">开设设置</asp:LinkButton>
