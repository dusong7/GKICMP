<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DKDetail.aspx.cs" Inherits="GKICMP.educational.DKDetail" %>
        ...
        <div class="listcent pad0">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="listinfo">
                <tbody>
                    ...
                    <tr>
                        <td align="right" width="120">申请人：</td>
                    ...
                    <tr>
                        <td align="right" width="120">代课时间：</td>
                        <td align="left">
                    ...
                    <tr>
                        <td align="right" width="120">代课原因：</td>
                        <td align="left" colspan="3">
                            <asp:Literal ID="ltl_ApplyReason" runat="server"></asp:Literal>
                        </td>
                    </tr>
                    <tr>
                        <td align="right" width="120">代课状态：</td>
                        <td align="left">
