<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DKAuditList.aspx.cs" Inherits="GKICMP.educational.DKAuditList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function editinfo(e) {
            var id = $(e).next().val();
            return openbox('A_id', 'DKAuditEdit.aspx', 'id=' + id, 740, 400, 0);
        }
        function viewinfo(e) {
            var id = $(e).next().val();
                    ...
                    <asp:Repeater runat="server" ID="rp_List">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td>
                                    <asp:LinkButton ID="lbtn_Pass" runat="server" CssClass="listbtn btneditcolor" ToolTip="通过" OnClientClick='return editinfo(this);'>通过</asp:LinkButton>
                                    <asp:HiddenField ID="HiddenField1" Value='<%#Eval("SubID") %>' runat="server" />
                                    <asp:LinkButton ID="lbtn_Reject" runat="server" CssClass="listbtn btndeletecolor" ToolTip="驳回" CommandArgument='<%#Eval("SubID") %>' OnClick="lbtn_Detail_Click">驳回</asp:LinkButton>
