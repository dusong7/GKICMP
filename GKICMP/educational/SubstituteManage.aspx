<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubstituteManage.aspx.cs" Inherits="GKICMP.educational.SubstituteManage" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        //        return openbox('A_id', 'SubstituteAdd.aspx', '', 740, 400, -1);
        //    });
        //});
        //function editinfo(e) {
        //    var id = $(e).next().val();
        ...
        function viewinfo(e) {
            var id = $(e).next().val();
            return openbox('A_id', 'SubstituteDetail.aspx', 'id=' + id, 740, 500, 4);
        }
        ...
        <div class="positionc">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td class="positiona"><a>首页</a><span>></span><asp:Label ID="lbl_ParentMenu" runat="server" Text=""></asp:Label><span>></span><asp:Label ID="lbl_Menuname" runat="server" Text="调课管理"></asp:Label>
                    </td>
                </tr>
            </table>
        </div>
