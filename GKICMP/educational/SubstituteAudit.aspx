<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubstituteAudit.aspx.cs" Inherits="GKICMP.educational.SubstituteAudit" %>
    ...
    <script type="text/javascript">
        $(function () {
            $('#btn_Add').click(function () {
                ...
                return openbox('A_id', 'SubstituteAuditEdit.aspx', '', 400, 200, -3);
            });
        });
        //function editinfo(e) {
        //    var id = $(e).next().val();
        ...
        function viewinfo(e) {
            var id = $(e).next().val();
            return openbox('A_id', 'SubstituteDetail.aspx', 'id=' + id, 740, 400, 4);
        }
    ...
    <form runat="server">
        ...
        <div class="positionc">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td class="positiona"><a>首页</a><span>></span><asp:Label ID="lbl_ParentMenu" runat="server" Text=""></asp:Label><span>></span><asp:Label ID="lbl_Menuname" runat="server" Text="调课审核管理"></asp:Label>
                    </td>
                </tr>
            </table>
        </div>
        <div class="listcent searclass">
            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="10">
                <tbody>
                    <tr>
                        <td align="right" width="65">调课人：</td>
                        <td width="150">
                            <asp:TextBox ID="txt_SubUser" Text="" runat="server"></asp:TextBox>
                        </td>
                        <td align="right" width="70">开始日期：
                        </td>
                        <td>
                ...
                <tbody>
                    <tr>
                        <td align="right" valign="middle">
                            <asp:Button ID="btn_Add" runat="server" Text="审核"  CssClass="listbtncss listadd"  />
                            ...
                            <tr>
                                <td style="width: 5px">
                                    <label class="wxz" id='ck_<%#Eval("SubID")%>l'>
                                        <input type="checkbox" name="checkbox" onclick="setid(this.id)"  value='<%#Eval("SubID")%>' id='ck_<%#Eval("SubID") %>' <%#Convert.ToInt32(Eval("SubState"))==(int)GK.GKICMP.Common.CommonEnum.PraState.申请中?"":"disabled" %> /></label>
                                </td>
