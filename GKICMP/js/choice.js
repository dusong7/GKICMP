...
$(function () {
    ...
    $("#btn_Release").click(function () {
        return checkselectone("发布", "信息");
    });
    $("#btn_Report").click(function () {
        return checkselectone("上报", "信息");
    });
    //禁用
    $("#btn_Detain").click(function () {
...
function openbox(idval, urlval, dataval, widthval, heighval, type, isparent) {
    ...
    //ID设置
    var parms = "";
    if (type == 10 || type == 11 || type == 12 || type == 15 || type == 16 || type == 20 || type == 21 || type == 22 || type == 23 || type == 24 || type == 28 ) {
        $("#hf_Page").val("1");
        var checkid = document.getElementById("hf_CheckIDS").value;
        var flag = IsOnly(checkid);
        if (flag == 0)//未选
...
function settitle(title, flag) {
    switch (flag) {
        ...
        case 44: title += "_毕业"; break;
        case 45: title += "_变动添加"; break;
        case 46: title += "_删除"; break;
        case 47: title += "_安排"; break;
        case 48: title += "_退费"; break;
        case 49: title += "_调课"; break;
        case 50: title += "_选取"; break;
        case 51: title += "_加密"; break;
        case 52: title += "_配置教师"; break;
        case 53: title += "报名"; break;
        case 54: title += "引用视频"; break;
        case 55: title += "_发布练习"; break;
        case 56: title += "_设置"; break;
        case 57: title += "_驳回"; break;

        case 58: title += "_选课名单"; break;
        case 59: title += "_退课名单"; break;

        case 60: title += "_移交"; break;
        case 62: title += "_分班"; break;
            // case 51: title += "_选取"; break;
        default: break;
    };
    return title;
}
