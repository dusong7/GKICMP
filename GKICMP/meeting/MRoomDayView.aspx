<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MRoomDayView.aspx.cs" Inherits="GKICMP.meeting.MRoomDayView" %>
...
<body>
    <form id="form1" runat="server">
                ...
                <tbody>
                    <tr>
                        <th colspan="7" align="left">
                            <div class="xxsm">
                                <ul>
                                    <li class="selected"><a href="MRoomDayView.aspx">日视图</a></li>
                                    <li><a href="MRoomWeekView.aspx">周视图</a></li>
                                </ul>
                            </div>
                        </th>
                    </tr>
        ...
        <div class="listcent pad0">
            <table width="99%" border="0" cellpadding="0" cellspacing="0" class="listinfo">
                <thead>
                    <tr>
                        <td rowspan="2" style="font-weight: bold; border-right: 1px solid #cccccc; text-align: center; border-top: 1px solid #cccccc;">会议室名称
                        </td>
                        <asp:Literal ID="ltl_Hours" runat="server"></asp:Literal>
                    </tr>
                    <tr>
                        <asp:Literal ID="ltl_Mins" runat="server"></asp:Literal>
                    </tr>
                </thead>
