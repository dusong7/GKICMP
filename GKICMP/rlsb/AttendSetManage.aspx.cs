    ...
    public partial class AttendSetManage : PageBase
    {
        ...
        public void DataBindList()
        {
           ...
           // model.IsUse = Convert.ToInt32(ViewState["IsUse"].ToString());
            ...
            DataTable dt = AttendSetDAL.GetPaged(Pager.PageSize, Pager.CurrentPageIndex, ref recordCount, model);
        ...
        protected void btn_Delete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int result = AttendSetDAL.DeleteBat1(ids);
                if (result > 0)
                {
                    ShowMessage("删除成功");
        ...
        protected void lbtn_IsDisable_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int result = AttendSetDAL.UpdateByID1(Convert.ToInt32(lb.CommandArgument.ToString()), (int)CommonEnum.IsorNot.是);
                if (result > 0)
                {
                    ShowMessage("启用成功");
