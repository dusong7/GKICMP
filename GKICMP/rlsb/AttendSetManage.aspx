<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AttendSetManage.aspx.cs" Inherits="GKICMP.rlsb.AttendSetManage" %>
    ...
    <form runat="server">
        ...
        <div class="listcent searclass">
            <%--<table width="99%" border="0" align="center" cellpadding="0" cellspacing="10">
                <tbody>
                    <tr>
                        <td width="70" align="right">上午开始时间：</td>
                        <td width="240">
                        ...
                        <ItemTemplate>
                            <tr>
                                ...
                                <td><%#Eval("MEnd","{0:HH:mm:ss}")%></td>
                                 <td><%#Eval("RoleName")%></td>
                                <td><%#Eval("OutType").ToString()=="1"?"进入":"离开"%></td>
                                <td><%#GK.GKICMP.Common.CommonFunction.CheckEnum<GK.GKICMP.Common.CommonEnum.IsorNot>(Eval("IsUse")) %></td>
                                <td>
                                    <asp:LinkButton ID="lbtn_Edit" runat="server" CssClass="listbtn btneditcolor"  ToolTip="编辑" Visible='<%#Eval("IsUse").ToString()=="1"? false:true %>' OnClientClick='return editinfo(this);'>编辑</asp:LinkButton>
