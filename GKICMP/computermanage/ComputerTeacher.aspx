<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ComputerTeacher.aspx.cs" Inherits="GKICMP.computermanage.ComputerTeacher" %>
                    ...
                    <th colspan="7" align="left" style="padding-left: 15px">
                        <div class="xxsm">
                            <ul>
                                ...
                                <li class="selected"><a href="ComputerTeacher.aspx">按教师统计</a></li>
                                <li><a href="ComputerDepartment.aspx">按部门统计</a></li>
                                <li><a href="ComputerSum.aspx">按月份统计</a></li>
