...
{
    public partial class ComputerSubject : System.Web.UI.Page
    {
        ...
        public void InfoBind()
        {
            ...
            DataTable dtsum = computerRegDAL.CountsCID(Convert.ToDateTime(ViewState["begin"].ToString()), Convert.ToDateTime(ViewState["end"].ToString()));
            ...
            if (dtsum != null && dtsum.Rows.Count > 0)
            {
                ...
                {
                    a += "['" + dr["CName"].ToString() + "'," + dr["zg"].ToString() + "],";
                }
        ...
        protected void btn_OutPut_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = computerRegDAL.CountsCID(Convert.ToDateTime(ViewState["begin"].ToString()), Convert.ToDateTime(ViewState["end"].ToString()));
