...
{
    public partial class ComputerDepartment : System.Web.UI.Page
    {
        ...
        public void GetCondition()
        {
            ...
            //ViewState["begin"] = "1900-01-01 00:00:01";
            //ViewState["end"] = "9999-12-31 23:59:59";
        }
        #endregion
        ...
        public void InfoBind()
        {
            ...
            //统计班班通记录总数
            DataTable dt = computerRegDAL.GetListSum(Convert.ToDateTime(ViewState["begin"].ToString()), Convert.ToDateTime(ViewState["end"].ToString()));
            this.ltl_Sum.Text = "总共：" + dt.Rows[0]["zg"] + "  条登记记录";

            DataTable dtsum = computerRegDAL.GetListDep(Convert.ToDateTime(ViewState["begin"].ToString()), Convert.ToDateTime(ViewState["end"].ToString()));
        ...
        protected void btn_OutPut_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = computerRegDAL.GetListDep(Convert.ToDateTime(ViewState["begin"].ToString()), Convert.ToDateTime(ViewState["end"].ToString()));
