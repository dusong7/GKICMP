...
{
    public partial class ComputerSum : System.Web.UI.Page
    {
        ...
        public void InfoBind()
        {
            ...
            DataTable dtsum = computerRegDAL.GetListCounts(Convert.ToDateTime(ViewState["begin"].ToString()), Convert.ToDateTime(ViewState["end"].ToString()));
        ...
        protected void btn_OutPut_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = computerRegDAL.GetListCounts(Convert.ToDateTime(ViewState["begin"].ToString()), Convert.ToDateTime(ViewState["end"].ToString()));
