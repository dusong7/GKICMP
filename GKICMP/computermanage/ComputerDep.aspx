<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ComputerDep.aspx.cs" Inherits="GKICMP.computermanage.ComputerDep" %>
            ...
            <tbody>
                <tr>
                    <th colspan="7" align="left" style="padding-left: 15px">
                        <div class="xxsm">
                            <ul>
                                <li class="selected"><a href="ComputerDep.aspx">按设备统计</a></li>
                ...
                <tbody>
                    ...
                    <asp:Repeater ID="rp_List" runat="server">
                        <ItemTemplate>
                            ...
                            <tr>
                                <td align="center"><%#Eval("ComputerName") %></td>
