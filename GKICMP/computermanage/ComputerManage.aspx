<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ComputerManage.aspx.cs" Inherits="GKICMP.computermanage.ComputerManage" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            $('#btn_Add').click(function () {
                ...
                return openbox('A_id', 'ComputerEdit.aspx', '&flag=' + document.getElementById("hf_CID").value, 640, 360, -1);
            });
        });
        function editinfo(e) {
            var id = $(e).next().val();
            var flag = document.getElementById("hf_CID").value;
            return openbox('A_id', 'ComputerEdit.aspx', 'id=' + id + '&flag=' + flag, 640, 360, 0);
        }
