...
{
    public partial class ComputerTeacher : System.Web.UI.Page
    {
        ...
        public void InfoBind()
        {
            ...
            DataTable dt = computerRegDAL.GetList(Convert.ToDateTime(ViewState["begin"].ToString()), Convert.ToDateTime(ViewState["end"].ToString()));
           
            //统计班班通记录总数
            DataTable dtsum = computerRegDAL.GetListSum(Convert.ToDateTime(ViewState["begin"].ToString()), Convert.ToDateTime(ViewState["end"].ToString()));
            this.ltl_Sum.Text = "总共：" + dtsum.Rows[0]["zg"]+"  条登记记录";
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                ...
                {
                    a += "['" + dr["CreaterUserName"].ToString() + "'," + dr["zg"].ToString() + "],";
                }
                ...
                //sb.Append("                 ['未处理', " + dtsum.Rows[0]["wcl"] + "],");
                //sb.Append("                 ['已受理', " + dtsum.Rows[0]["sl"] + "],");
                //sb.Append("                 ['完成', " + dtsum.Rows[0]["wc"] + "],");
                //sb.Append("                 ['确认完成', " + dtsum.Rows[0]["qrwc"] + "],");
                sb.Append(a);
                sb.Append("             ],");
