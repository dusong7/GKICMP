...
{
    public partial class WFAuditManage : PageBase
    {
        ...
        {
            int recordCount = -1;
            DataTable dt = new WF_CustomizedDAL().GetPagedList(Pager.PageSize, Pager.CurrentPageIndex, ref recordCount, UserID, "");
