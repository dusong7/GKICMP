<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WFSendManage.aspx.cs" Inherits="GKICMP.customizedworkflow.WFSendManage" %>
                    ...
                    <asp:Repeater runat="server" ID="rp_List">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td>
                                    <asp:LinkButton ID="lbtn_Audit" runat="server" CssClass="listbtn btneditcolor" ToolTip="查看" OnClientClick='return audit(this);'>查看</asp:LinkButton>
