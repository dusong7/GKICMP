<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchaseAcceptance.aspx.cs" Inherits="GKICMP.purchase.PurchaseAcceptance" %>
    ...
    <script type="text/javascript">
        $(function () {
            $('#btn_Add').click(function () {
                ...
                return openbox('A_id', 'PurchaseAcceptanceEdit.aspx', '', 1000, 550, -1);
            });
        });
        function editinfo(e) {
            var id = $(e).next().val();
            return openbox('A_id', 'PurchaseAcceptanceEdit.aspx', 'id=' + id, 1000, 550, 0);
        }
        function viewinfo(e) {
            var id = $(e).next().val();
            return openbox('A_id', 'PurchaseAcceptanceDetail.aspx', 'id=' + id, 960, 500, 4);
        }
