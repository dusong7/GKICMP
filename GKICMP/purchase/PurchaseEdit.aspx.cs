...
{
    public partial class PurchaseEdit : PageBase
    {
        ...
        public void InfoBind()
        {
            try
            {
                ...
                if (model != null)
                {
                    this.txt_PTitle.Text = model.PTitle;
                    this.txt_PEstimate.Text = model.PEstimate.ToString();
                    this.txt_PDesc.Text = model.PDesc;
                }
                GetPurchaseBill();
                GetAuditUser();
            }
        ...
        private void GetPurchaseBill()
        {
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                ...
                this.hf_Bill.Value = "true";
            }
            else
            {
                this.tr_null.Visible = true;
                this.hf_Bill.Value = "false";
            }
        ...
        private void GetAuditUser()
        {
            ...
            if (dt != null && dt.Rows.Count > 0)
            {
                ...
                this.hf_Audit.Value = "true";
            }
            else
            {
                this.ltl_Name.Visible = true;
                this.hf_Audit.Value = "false";
            }
        ...
        protected void btn_Submit_Click(object sender, System.EventArgs e)
        {
            try
            {
                if (!bool.Parse(this.hf_Audit.Value))
                {
                    ShowMessage("请选择审核人");
                    return;
                }
                if (!bool.Parse(this.hf_Bill.Value))
                {
                    ShowMessage("请添加采购明细");
                    return;
                }
                ...
                model.IsChecked = (int)CommonEnum.IsorNot.否;
