<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Purchase_FileDelete.aspx.cs" Inherits="GKICMP.purchase.Purchase_FileDelete" %>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="listinfo1">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:DropDownList runat="server" ID="ddl_ProName" datatype="ddl" errormsg="请选择采购名称"></asp:DropDownList>
