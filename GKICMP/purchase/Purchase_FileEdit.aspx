<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Purchase_FileEdit.aspx.cs" Inherits="GKICMP.purchase.Purchase_FileEdit" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="listcent pad0">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="listinfo1">
                <tbody>
                    <tr>
                        <th colspan="4" align="left">采购文件信息</th>
                    </tr>
                    <tr>
                        <td align="right">采购名称</td>
                        <td align="left">
                            <asp:DropDownList runat="server" ID="ddl_ProName" AutoPostBack="True"  datatype="ddl" errormsg="请选择采购名称"  OnSelectedIndexChanged="ddl_ProName_SelectedIndexChanged"></asp:DropDownList>
