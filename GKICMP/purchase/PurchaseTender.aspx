<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchaseTender.aspx.cs" Inherits="GKICMP.purchase.PurchaseTender" %>
    ...
    <script type="text/javascript">
        $(function () {
            $('#btn_Add').click(function () {
                ...
                return openbox('A_id', 'PurchaseTenderEdit.aspx', '', 1000, 500, -1);
            });
            $('#btn_Return').click(function () {
                //box的ID，Url,data传值，宽，高,Type(-1为添加，0为修改,其他为查看)
                return openbox('A_id', 'PurchaseTenderReturn.aspx', '', 500, 200, 24);
            });
        });
        function editinfo(e) {
            var id = $(e).next().val();
            return openbox('A_id', 'PurchaseTenderEdit.aspx', 'id=' + id, 1000, 500, 0);
        }
        function viewinfo(e) {
            var id = $(e).next().val();
            return openbox('A_id', 'PurchaseTenderDetail.aspx', 'id=' + id, 960, 440, 4);
        }
