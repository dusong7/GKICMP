<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JZProjectCheckEdit.aspx.cs" Inherits="GKICMP.projectmanage.JZProjectCheckEdit" %>
    ...
    <style>
        .selecttd {
         float:left !important;position:relative}
            .selecttd input {position:absolute; left:0px; top:14px}
            .selecttd label {
             margin-left:20px}
    ...
    <form id="form1" runat="server">
        <div class="listcent pad0">
            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="listinfo">
                <tbody>
                    <tr>
                        <th colspan="4" align="left">教装项目验收</th>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td align="left">
                             <span class="selecttd"><asp:CheckBox ID="cb_BrandChecked" runat="server"  Text="品牌场地是否正确"   /> </span>
                             <span class="selecttd"><asp:CheckBox ID="cb_SpecificationChecked" runat="server" Text="规格型号是否正确"  /></span>
                             <span class="selecttd"><asp:CheckBox ID="cb_ConfigChecked" runat="server" Text="配置是否正确"  /> </span>
                             <span class="selecttd"><asp:CheckBox ID="cb_CountChecked" runat="server"  Text="数量是否正确" /> </span>
                             <span class="selecttd"><asp:CheckBox ID="cb_DebuggingChecked" runat="server" Text="安装调试是否正常"  /></span>
                             <span class="selecttd"><asp:CheckBox ID="cb_GuaranteeChecked" runat="server" Text="是否有保修卡" /></span>
                             <span class="selecttd"><asp:CheckBox ID="cb_PackingChecked" runat="server" Text="是否包装完好"  /> </span>
                             <span class="selecttd"><asp:CheckBox ID="cb_ContractChecked" runat="server" Text="是否签订合同"  /></span>
                        </td>
                    </tr>
