<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="JZProjectImport.aspx.cs" Inherits="GKICMP.projectmanage.JZProjectImport" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function importview(e) {
            var id = $(e).next().val();
            return openbox('A_id', 'JZProjectImportDetail.aspx', 'id=' + id, 960, 630, 4);
        }
        function importa(e) {
            var id = $(e).next().next().val();
            return openbox('A_id', 'JZProjectImportEdit.aspx', 'id=' + id, 960, 630, 3);
        }
    </script>
</head>
<body>
                    ...
                    <asp:Repeater runat="server" ID="rp_List">
                        <ItemTemplate>
                            <tr>
                                ...
                                <td><%#Eval("PType").ToString()=="0"?"<span style='color:red'>未上报</span>":"已上报"%></td>
                                <td>
                                    ...
                                    <asp:LinkButton ID="lbtn_Report" runat="server" CssClass="listbtn btnreportncolor" ToolTip="上报"  CommandArgument='<%#Eval("PID") %>' OnClick="lbtn_SB_Click" OnClientClick="return  confirm('您确认要上报该信息吗？');">上报</asp:LinkButton>
                                </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
