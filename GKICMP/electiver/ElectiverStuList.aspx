<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ElectiverStuList.aspx.cs" Inherits="GKICMP.electiver.ElectiverStuList" %>
        ...
        <div class="positionc">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                    ...
                    <td class="positiona"><a>首页</a><span>></span><asp:Label ID="lbl_ParentMenu" runat="server" Text=""></asp:Label><span>></span><asp:Label ID="lbl_Menuname" runat="server" Text="班级选课名单"></asp:Label>
                </tr>
            </table>
        </div>
        <table width="98%" align="center" border="0" cellpadding="0" cellspacing="0">
            <tr style="background: url(../images/tabimg/tabpic3.gif) bottom; vertical-align: middle; height: 30px">
                ...
                <td valign="top" rowspan="2">
                    <iframe scrolling="auto" width="100%" frameborder="0" src="ElectiverStuManage.aspx" name="framemain"
