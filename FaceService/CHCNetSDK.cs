    ...
    public class CHCNetSDK
    {
        ...
        **************************************************/
        ...
        public struct NET_DVR_STD_CONFIG
        {
            ...
            public IntPtr dwCondSize;
            public IntPtr lpInBuffer;
            public IntPtr dwInSize;
            public IntPtr lpOutBuffer;
            public IntPtr dwOutSize;
            public IntPtr lpStatusBuffer;
            public IntPtr dwStatusSize;
            public IntPtr lpXmlBuffer;
            public IntPtr dwXmlSize;
        ...
        **********************************************************/
        ...
        [DllImport(@"HCNetSDK.dll")]
        public static extern int NET_DVR_SetupAlarmChan_V41(int lUserID, NET_DVR_SETUPALARM_PARAM lpSetupParam);
        ...
        ******************************************************************************/
        ...
        [DllImportAttribute(@"HCNetSDK.dll")]
        public static extern int NET_DVR_StartRemoteConfig(int iUserID, uint dwCommand, IntPtr lpInBuffer, uint dwInBufferLen, fRemoteConfigCallback cbStateCallback, IntPtr pUserData);


        [DllImportAttribute(@"HCNetSDK.dll")]
        public static extern bool NET_DVR_GetSTDConfig(int iUserID, IntPtr dwCommand, ref NET_DVR_STD_CONFIG lpConfigParam);
        ...
        public struct NET_DVR_ACS_CFG
        {
            ...
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 503, ArraySubType = UnmanagedType.I1)]
        ...
        public struct NET_DVR_ACS_EVENT_DETAIL
        {
            ...
            public UInt16 wLocalControllerID;
        ...
        {
            public uint dwSize;
            public IntPtr IpRequestUrl;
            public uint dwRequestUrlLen;
            public IntPtr IpInBuffer;
        ...
        [DllImportAttribute(@"HCNetSDK.dll")]
        public static extern bool NET_DVR_STDXMLConfig(int iUserID, NET_DVR_XML_CONFIG_INPUT lpInputParam, ref NET_DVR_XML_CONFIG_OUTPUT lpOutputParam);
        ...
        [DllImportAttribute(@"HCNetSDK.dll")]
        public static extern bool NET_DVR_SetDeviceConfig(int iUserID, uint dwCommand, uint dwCount,
             IntPtr IpInBuffer,
            uint dwInBufferSize,
           IntPtr lpStatusList,
        ...
        //[DllImportAttribute(@"HCNetSDK.dll")]
        //public static extern bool NET_DVR_GetDVRConfig(int iUserID, uint dwCommand, int lChannel,
        //       IntPtr lpOutBuffer,
